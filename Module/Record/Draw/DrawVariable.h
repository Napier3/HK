...
public:
	...
	CMemBufferInterface* m_pnAttachBuffer;//unsigned short
...
protected:
	CXDrawList *m_pDrawList;

public:
	void SetDrawList(CXDrawList *pDrawList)	{	m_pDrawList = pDrawList;	}
	virtual void DrawElements(CDC* pDC, double fZoomRatio,const CPoint &ptOffset, DWORD dwDrawFlag=0xFFFFFFFF);
};
