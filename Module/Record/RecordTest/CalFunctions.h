...
// #define RT_FREQUENCY_CAL_LEN   512
#define RT_FREQUENCY_CAL_LEN   1024
#define RT_FREQUENCY_CAL_LEN_ADD   10

extern long g_nRtFrequencyCalMode;

inline BOOL rt_is_frequency_cal_mode_dft()
{
	return g_nRtFrequencyCalMode == FREQUENCY_CAL_MODE_DFT;
}

inline BOOL rt_is_frequency_cal_mode_fft()
{
	return g_nRtFrequencyCalMode == FREQUENCY_CAL_MODE_FFT;
}


inline BOOL rt_is_frequency_cal_mode_fft_dft()
{
	return g_nRtFrequencyCalMode == FREQUENCY_CAL_MODE_FFT_DFT;
}
