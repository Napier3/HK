...
#define XLOGLEVEL_RESULT    				8
#define XLOGLEVEL_ASSIST    				9
...
private:
	...
	BOOL m_bSaveLogFileEveryLog;  //每写一条日志都保存一下文件   shaolei 2023-1-4
...
public:
	static void SetSaveEveryLogFlag(BOOL bSave)		{	g_pLogPrint->m_bSaveLogFileEveryLog = bSave;		}
