...
void CDvmCmpDsStandPropGridCtrl::OnContextMenu(CWnd* pWnd, CPoint point)
{
	...
	//menu.AppendMenu(MF_STRING,ID_DVMMAP_CREATEDATAMAP_STAND, g_sLangTxt_CreatDataMap/*_T("创建数据映射")*/);//g_sLangTxt_CreatDataMap为空无法显示
	...
	if (pMap->m_pMap != NULL)
	{
		...
		//menu.AppendMenu(MF_STRING,ID_DVMMAP_DELETEDATAMAP_STAND, g_sLangTxt_DeleteDataMap/*_T("删除数据映射")*/);//g_sLangTxt_DeleteDataMap为空无法显示
