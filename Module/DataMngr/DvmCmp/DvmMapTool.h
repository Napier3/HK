...
public:
	...
	//2023-4-18  lijunqing
	CThreadProgressInterface *m_pPrgsInterface;
...
// 	CDvmCmpObj* CmpDvmValueVal(CDvmValue *pStand, CDvmValue *pDestCmpValue);
	...
	//20231102 huangliang 
	CDvmData* FindCmpDataMapValue(CExBaseList *pDest, CDvmValue *pStandValue);
	void CmpDataMapValue(CDvmDataset *pDestDataset, CDvmData *pStand, CDvmDataMap *pDataMap);
	bool CmpDataMapValue(CDvmDataset *pDestDataset, CDvmValue *pStandValue, CDvmDataMap *pDataMap, bool bDelParent);
