...
public:
	...
	{
        g_pStrCmpBuf1 = nullptr;
        g_pStrCmpBuf2 = nullptr;
		m_nLength = 0;
	}
...
private:
	...
	void Free()
	{
        if (g_pStrCmpBuf1 != nullptr)
		{
			delete g_pStrCmpBuf1;
            g_pStrCmpBuf1 = nullptr;
		}

        if (g_pStrCmpBuf2 != nullptr)
		{
...
{   
    ...
    BYTE *pnSourceSz = nullptr;
    BYTE *pnSubSz    = nullptr;
...
void CStringCmp::InitBlocks(CStringCmpBlocks *pBlocks, BYTE *pBuff, long nLen, CString *pStr)
{
    ...
    long nBegin = 0;
    CStringCmpBlock *pStringCmpBlock = nullptr;
...
#ifdef _DEBUG
	CLogPrint::LogFormatString(XLOGLEVEL_TRACE, _T("%s   <===>   %s"), strPathSrc, strPathDest);
	oStrCmp.m_oStrCmpBlks1.Log(CMPSTATE_UNMATCH);
	oStrCmp.m_oStrCmpBlks2.Log(CMPSTATE_UNMATCH);
#endif

	BOOL bRet = FALSE;
    CStringCmpBlock *pBlk1 = nullptr, *pBlk2 = nullptr;
