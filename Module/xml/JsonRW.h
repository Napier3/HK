...
public:
    ...
    virtual BOOL xml_PutText(const CString &strText,const BSTR strAttrName = nullptr);
    virtual CString xml_GetText(const BSTR strAttrName = nullptr);

    virtual BOOL xml_GetCDATA(CString &strText,const BSTR strAttrName = nullptr);
    virtual BOOL xml_SetCDATA(CXmlRWDocBase &oXMLDoc,const CString &strText,const BSTR strAttrName = nullptr);
...
public:
	...
	virtual long GetXmlRWType(){return _JSON_TYPE_;}
    virtual BOOL IsEmpty(){return (m_pJsonNode == nullptr);}
...
public:
    ...
    virtual BOOL IsValid(){return m_pJsonDoc != nullptr;}
