...
SttCustomSetDlg::SttCustomSetDlg(QWidget *parent, Qt::WindowFlags f)
: QDialog(parent, f)
{
	ui.setupUi(this);
    ...
    m_pSttMenus = nullptr;
    m_pToolBar = nullptr;
    m_pSttFrameConfig = nullptr;

    m_pFloatBarList = nullptr;
    m_pMenutList = nullptr;
    m_pCurrFloatBarData = nullptr;
    m_pCurrMenuData = nullptr;
    m_pCurrMenuItem =nullptr;
    m_pCurrFloatBarItem = nullptr;
...
void SttCustomSetDlg::EnableBtns()
{
    ...
    if((m_pCurrFloatBarItem == nullptr)||(m_pCurrMenuItem == nullptr))
	{
		return;
	}
...
void SttCustomSetDlg::GetCurrItemData()
{
    ...
    if (m_pCurrFloatBarItem != nullptr)
	{
		if (m_pCurrFloatBarItem->m_pItemData->GetClassID() == MNGRCLASSID_CSTTFRAME_BUTTON)	
		{
...
BOOL SttCustomSetDlg::IsCurrSelMenuItemInBar()
{
    ...
    CSttFrame_BarBase *pTooBar =nullptr;
