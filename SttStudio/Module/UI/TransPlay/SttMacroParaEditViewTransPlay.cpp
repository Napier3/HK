...
QSttMacroParaEditViewTransPlay* g_pReplayTestMain =nullptr;
    ...
    :CSttMacroParaEditViewOriginal(parent)
{
    ...
    m_pWaveGraphWidget = nullptr;
    m_pSttProgDlg = nullptr;
...
void QSttMacroParaEditViewTransPlay::StartProgDlg(const CString &strTitle)
{
    if (m_pSttProgDlg == nullptr)
	{
        m_pSttProgDlg = new QSttProgDlg(nullptr);
...
void QSttMacroParaEditViewTransPlay::OnViewTestStop()
{
    ...
    if(g_theBigComtradeTransPlay->m_pSttComtradeFileReadThread != nullptr)
	{
...
// 	QTextCodec *pOldTextCodec = nullptr;//不应该在此处增加处理
...
#ifdef _PSX_QT_LINUX_
    pthread_create(&m_pSttOpenComtradeFileThread,nullptr,SttOpenComtradeFileThread,(LPVOID)this );
#else
    m_pSttOpenComtradeFileThread =  CreateThread(nullptr,nullptr,(LPTHREAD_START_ROUTINE)SttOpenComtradeFileThread,(LPVOID)this,0,nullptr);
#endif
	CString strProgTitle;
...
{
#ifdef _PSX_QT_LINUX_
    pthread_create(&m_pSttInsertWaveThread,nullptr,SttInsertWaveThread,(LPVOID)this );
#else
    m_pSttInsertWaveThread = CreateThread(nullptr,nullptr,(LPTHREAD_START_ROUTINE)SttInsertWaveThread,(LPVOID)this,0,nullptr);
#endif
...
bool QSttMacroParaEditViewTransPlay::isNeedAnalogModule()
{
    ...
    if (g_theBigComtradeTransPlay == nullptr)
	{
		return false;
	}
