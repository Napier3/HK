...
//		m_pUIParaWidget->setPropertyOfParaSet(P_Common,g_theTestCntrFrame->GetSttTestResource(),m_pSTOverPara->m_uiVOL,m_pSTOverPara->m_uiCUR);
//		m_pUIParaWidget->setMaxMinAndEDVal();
...
void QttMacroParaEditViewShortTimOver::SetDatas(CDataGroup *pDataset)
{
	...
	g_theTestCntrFrame->InitVectorWidget(m_pSTOverPara->m_uiVOL,m_pSTOverPara->m_uiCUR);
...
// 		//disconnect(m_pUIParaWidget,SIGNAL(sig_updataParas()),this,SLOT(slot_UpdateVecterViews()));
// 		m_pUIParaWidget->setMacroType(MACROTYPE_State);
// 		m_pUIParaWidget->setPropertyOfParaSet(P_Common,g_theTestCntrFrame->GetSttTestResource(),
