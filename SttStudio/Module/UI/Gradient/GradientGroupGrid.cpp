...
//#define GenHao3	1.7320508 //¸ùºÅÈý
...
QGradientGroupGrid::QGradientGroupGrid(QWidget* pParent) : QExBaseListGridBase(pParent)
{
    ...
    m_ActUAmpED = nullptr;
    m_ActUZero = nullptr;
    m_ActUEqualAmp = nullptr;
    m_ActIAmp1 = nullptr;
    m_ActIAmp5 = nullptr;
    m_ActIAmp0 = nullptr;
    m_ActIqualAmp = nullptr;
    m_ActIAmpED = nullptr;
    m_bRunning = false;
	m_bDC = FALSE;
...
void QGradientGroupGrid::CreatTableMenu(long nType)
{
	...
	if (nType==Moudle_U)//µçÑ¹Ä£¿é
	{
		m_moudleType = Moudle_U;
		m_fEDVal = g_oSystemParas.m_fVNom;
		m_ActUAmpED = new QAction(tr("¶î¶¨ÏàµçÑ¹"),this);
		m_ActUZero = new QAction(tr("Áã"),this);
		m_ActUEqualAmp = new QAction(tr("µÈ·ùÖµ"),this);
		...
		QAction* pActUAmpED20 = new QAction(tr("20%¶î¶¨ÏàµçÑ¹"),this);
		QAction* pActUAmpED40 = new QAction(tr("40%¶î¶¨ÏàµçÑ¹"),this);
		QAction* pActUAmpED60 = new QAction(tr("60%¶î¶¨ÏàµçÑ¹"),this);
		QAction* pActUAmpED80 = new QAction(tr("80%¶î¶¨ÏàµçÑ¹"),this);
		QAction* pActUAmpED120 = new QAction(tr("120%¶î¶¨ÏàµçÑ¹"),this);
		CString strEDPhaseV;
	...
	else//µçÁ÷Ä£¿é
	{
		...
		m_ActIAmp0 = new QAction(tr("Áã"),this);
		m_ActIqualAmp = new QAction(tr("µÈ·ùÖµ"),this);
		m_ActIAmpED = new QAction(tr("¶î¶¨µçÁ÷"),this);
		...
		QAction* pActIAmpED20 = new QAction(tr("20%¶î¶¨µçÁ÷"),this);
		QAction* pActIAmpED40 = new QAction(tr("40%¶î¶¨µçÁ÷"),this);
		QAction* pActIAmpED60 = new QAction(tr("60%¶î¶¨µçÁ÷"),this);
		QAction* pActIAmpED80 = new QAction(tr("80%¶î¶¨µçÁ÷"),this);
		QAction* pActIAmpED120 = new QAction(tr("120%¶î¶¨µçÁ÷"),this);
		CString strEDPhaseA;
	...
	QAction *m_ActUPhaseP = new QAction(tr("ÕýÐò"),this);
	QAction *m_ActUPhaseN = new QAction(tr("¸ºÐò"),this);
	QAction *m_ActUPhaseZ = new QAction(tr("ÁãÐò"),this);
	...
	QAction *m_ActIHzEqual = new QAction(tr("µÈÆµÂÊ"),this);
...
void QGradientGroupGrid::slot_ActPhasePClicked()
{
	...
	if (pItem && (pItem->flags() & Qt::ItemIsEditable))
	{
		...
		if (m_moudleType==Moudle_U)	//µçÑ¹Ä£¿é
		{
			if (m_pChDatas->GetCount()==4)
			{
