...
//sun #include "Webkit/SttReportViewHtml.h"
...
//sun #include "RemoteCtrl/SttMacroParaEditViewRemoteCtrl.h"
//sun #include "../SmartTestInterface/QT/PpSttIotEngineClientWidgetMain.h"
//sun #include "Module/CommConfigurationDlg/PkgMonitor/QSttCommCfgPkgMonitorWidget.h"
...
//	virtual void InitSttCap_MUTerminal();//合并单元智能终端测试时,初始化IEC探测功能
    ...
    //sun virtual BOOL CreateRemoteCtrlWidget();//2024.8.15 chenling 创建遥控的界面
...
public://界面相关变量
    ...
    CSttFrameConfig *m_pSttFrameConfig = nullptr;//框架配置参数管理对象
    QFont m_gFont;
    ...
    //sun QPpSttIotEngineClientWidget *m_pEngineClientWidget;
...
//sun 	QSttCommCfgPkgMonitorWidget *m_pSttCommCfgPkgWidget;
...
protected:
	...
	//测试报告视图
    //sun QSttReportViewHtml *m_pSttReportViewHtml;
    ...
    //sun QSttMacroParaEditViewRemoteCtrl *m_pRemoteCtrlWidget; //遥控 zhangyq 2023.12.25
private:
	QIcon m_imgStart;
	QIcon m_imgStop;
	QIcon m_imgTriger;
...
public:
    ...
    //sun QSttReportViewHtml* GetReportViewHtml(){ return m_pSttReportViewHtml; }
public:
...
public:
    ...
    //sun virtual void OnCmd_PkgMonitorDlg(); //报文监听对话框chenling20240301
