#ifndef CHANNELPOWERTABLE_H
#define CHANNELPOWERTABLE_H
...
public:
	QChannelPowerTable(MOUDLEType moudleType,CExBaseList *pChList,tmt_ChannelPower *pArrPOW,QWidget *parent = 0);
	virtual ~QChannelPowerTable();
	...
	void setMacroType(int type){ m_MacroType = 0; }
	virtual void setTableData(tmt_ChannelPower *pArrPOW);
...
public:
	...
	QString initMaxZeroAmp_RemoteMeas(MOUDLEType moudleType,QString str);//UO/I0限制处理 弱信号，UO 0-7.8/3，I0 0-4
