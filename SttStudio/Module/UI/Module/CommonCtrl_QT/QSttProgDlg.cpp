...
void QSttProgDlg::initUI(const CString &strTitle,const CString &strText)
{
	ReleaseUI();
    resize(100, 60);
    setMinimumSize(QSize(400, 60));
    setMaximumSize(QSize(400, 60));
    //setWindowFlags(Qt::CustomizeWindowHint | Qt::WindowTitleHint | Qt::WindowStaysOnTopHint | Qt::X11BypassWindowManagerHint);
