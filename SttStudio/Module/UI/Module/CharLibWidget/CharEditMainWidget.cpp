...
{
	if (m_strUI_ID == STT_ORG_MACRO_CurrInverseTimeTest)
	{
	...
	else if (m_strUI_ID == STT_ORG_MACRO_VolInverseTimeTest)
	{
		m_pImpCharactWidget = new QImpCharactWidget(this,true,true);
		m_pImpCharactWidget->setObjectName(QString::fromUtf8("QInverseCharactWidget"));
	...
	{
		m_pImpCharactWidget = new QImpCharactWidget(this,false,true);
