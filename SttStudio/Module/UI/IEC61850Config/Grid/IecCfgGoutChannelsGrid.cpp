...
void CIecCfgGoutChannelsGrid::InitGridTitle()
{
	...
	CString astrGridTitle[IECCFGSMVGOUTCHANNELS_GRID_COLS] = {strChDescription,strChType,strChMaps,strInitValue,g_sLangTxt_IEC_DescExternal.GetString()};
	int iGridWidth[IECCFGSMVGOUTCHANNELS_GRID_COLS]={300, 150,150,150,300};

	//20230725 suyang ÊÊÅä·Ö±æÂÊ 1024X768
