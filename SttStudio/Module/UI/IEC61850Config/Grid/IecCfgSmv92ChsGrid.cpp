...
void CIecCfgSmv92ChsGrid::InitGridTitle()
{
	...
	CString astrGridTitle[IECCFGSMV92CHS_GRID_COLS] = {strChDescription,strChType,strChMaps,strQuality,g_sLangTxt_IEC_DescExternal.GetString()};
...
void CIecCfgSmv92ChsGrid::ShowData(CExBaseObject *pData, int& nRow, BOOL bInsertRow)
{
	...
	if (pIecCfg92Ch->m_strName == NULL || pIecCfg92Ch->m_strName.Find(_T("Ch")) >= 0)//cl20231027设置通道缺省项
	{
