...
QSttMacroParaEditViewManual* g_pManualTest = nullptr;
    ...
    m_pManualTest_UI(new Ui::QSttMacroParaEditViewManual)
{
	...
	m_bIsChanging = FALSE;
    m_pGooseParaWidget = nullptr;
    m_pFT3OutParaWidget = nullptr;
...
void QSttMacroParaEditViewManual::slot_HarmCheck_stateChanged(int nState)
{
    ...
    if (m_oIV.m_pHarmUIParaWidget != nullptr)
	{
									...
									long nVolRsNum,long nCurRsNum,long nBinExNum,long nBoutExNum,BOOL bHasGoosePub)
{
	...
	if (bHasGoosePub)
	{
        ...
        CIecCfgGoutDatas *pGoutDatas = nullptr;
...
void QSttMacroParaEditViewManual::UpdateTestResource(BOOL bCreateChMaps)
{
	if ((m_pManualParas->m_nFuncType > TMT_MANU_FUNC_TYPE_Common)&&(m_pManualParas->m_nFuncType < TMT_MANU_FUNC_TYPE_MUTimingAccur))
	{
        ...
        if (m_pSetMUTestRpt_CheckBox != nullptr)
		{
...
void QSttMacroParaEditViewManual::UpdateFT3Tab_UI(CIecCfgDatasSMV* pIecCfgDatasSMV)
{
    ...
    if ((m_pFT3OutParaWidget == nullptr)&&(g_oSystemParas.IsDigitalOutputFT3())&&(g_oSttTestResourceMngr.m_nTotalFiberNum_STSend> 0) && (nFT3Block > 0))
	{
		AddFT3OutParaWidget(pIecCfgDatasSMV);
		connect(m_pFT3OutParaWidget, SIGNAL(sig_FT3DataChanged()), this, SLOT(slot_FT3DataChanged()));
	}
    else if ((m_pFT3OutParaWidget != nullptr)&&(!g_oSystemParas.IsDigitalOutputFT3()))
	{
		disconnect(m_pFT3OutParaWidget, SIGNAL(sig_FT3DataChanged()), this, SLOT(slot_FT3DataChanged()));
		RemoveFT3OutParaWidget();
	}
    else if ((m_pFT3OutParaWidget != nullptr)&&(g_oSystemParas.IsDigitalOutputFT3())&&(g_oSttTestResourceMngr.m_nTotalFiberNum_STSend> 0))
	{
// 		disconnect(m_pFT3OutParaWidget, SIGNAL(sig_FT3DataChanged()), this, SLOT(slot_FT3DataChanged()));
...
{
    if ((m_pGooseParaWidget == nullptr)&&(g_oSystemParas.m_nHasDigital)&&(g_oSttTestResourceMngr.m_nTotalFiberNum_LC> 0))//更新前无GOOSE界面,更新后需要GOOSE界面
	{
    ...
    else if ((m_pGooseParaWidget != nullptr)&&(!g_oSystemParas.m_nHasDigital))//更新前有GOOSE界面,更新后不需要
	{
    ...
    else if ((m_pGooseParaWidget != nullptr)&&(g_oSystemParas.m_nHasDigital))
	{
		disconnect(m_pGooseParaWidget, SIGNAL(sig_GooseDataChanged()), this, SLOT(slot_GooseDataChanged()));
		disconnect(m_pGooseParaWidget, SIGNAL(sig_RepairDataChanged()), this, SLOT(slot_GooseDataChanged()));
		disconnect(m_pGooseParaWidget, SIGNAL(sig_GoutMapChanged()), this, SLOT(slot_GoutMapChanged()));
    ...
    else if ((m_pGooseParaWidget != nullptr)&&(g_oSttTestResourceMngr.m_nTotalFiberNum_LC == 0))//更新前有GOOSE界面,更新后LC口为0不需要
	{
		disconnect(m_pGooseParaWidget, SIGNAL(sig_GooseDataChanged()), this, SLOT(slot_GooseDataChanged()));
		disconnect(m_pGooseParaWidget, SIGNAL(sig_RepairDataChanged()), this, SLOT(slot_GooseDataChanged()));
		disconnect(m_pGooseParaWidget, SIGNAL(sig_GoutMapChanged()), this, SLOT(slot_GoutMapChanged()));
...
void QSttMacroParaEditViewManual::InitMuComboBoxItem()
{
    ...
    if (m_pTestMethod_ComboBox != nullptr)
	{
    ...
    if (m_pMeasType_ComboBox != nullptr)
	{
		CString strText;
...
// 
// 	if ((pXSttCap_61850 == nullptr)||(m_pSttMUTimeTestWidget == nullptr)
// 		||(m_pManualParas == nullptr))
// 	{
// 		return;
// 	}
// 
// 	if (pXSttCap_61850->m_pDataset_MUTimeRlt == nullptr)
// 	{
// 		return;
// 	}
// 
...
{
    if ((m_pManualParas == nullptr)||(pDsRcdStep6U6I == nullptr))
	{
		return FALSE;
	}
...
void QSttMacroParaEditViewManual::slot_editTestTimeFinished()
{
    ...
    if (g_pSttIecRecordCbWidget != nullptr)
	{
