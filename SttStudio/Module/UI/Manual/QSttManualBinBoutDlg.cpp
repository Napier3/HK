...
void QSttManualBinBoutDlg::on_m_btnOK_clicked()
{
	...
	else
	{
		...
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[0].nSelect = 0;
	}
	if (ui->m_cbInB->checkState() == Qt::Checked)
	{
		m_pBinaryIn[1].nSelect = 1;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[1].nSelect = 1;
	}
	else
	{
		m_pBinaryIn[1].nSelect = 0;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[1].nSelect = 0;
	}
	if (ui->m_cbInC->checkState() == Qt::Checked)
	{
		m_pBinaryIn[2].nSelect = 1;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[2].nSelect = 1;
	}
	else
	{
		m_pBinaryIn[2].nSelect = 0;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[2].nSelect = 0;
	}
	if (ui->m_cbInD->checkState() == Qt::Checked)
	{
		m_pBinaryIn[3].nSelect = 1;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[3].nSelect = 1;
	}
	else
	{
		m_pBinaryIn[3].nSelect = 0;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[3].nSelect = 0;
	}
	if (ui->m_cbInE->checkState() == Qt::Checked)
	{
		m_pBinaryIn[4].nSelect = 1;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[4].nSelect = 1;
	}
	else
	{
		m_pBinaryIn[4].nSelect = 0;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[4].nSelect = 0;
	}
	if (ui->m_cbInF->checkState() == Qt::Checked)
	{
		m_pBinaryIn[5].nSelect = 1;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[5].nSelect = 1;
	}
	else
	{
		m_pBinaryIn[5].nSelect = 0;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[5].nSelect = 0;
	}
	if (ui->m_cbInG->checkState() == Qt::Checked)
	{
		m_pBinaryIn[6].nSelect = 1;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[6].nSelect = 1;
	}
	else
	{
		m_pBinaryIn[6].nSelect = 0;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[6].nSelect = 0;
	}
	if (ui->m_cbInH->checkState() == Qt::Checked)
	{
		m_pBinaryIn[7].nSelect = 1;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[7].nSelect = 1;
	}
	else
	{
		m_pBinaryIn[7].nSelect = 0;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[7].nSelect = 0;
	}
	if (ui->m_cbInI->checkState() == Qt::Checked)
	{
		m_pBinaryIn[8].nSelect = 1;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[8].nSelect = 1;
	}
	else
	{
		m_pBinaryIn[8].nSelect = 0;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[8].nSelect = 0;
	}
	if (ui->m_cbInJ->checkState() == Qt::Checked)
	{
		m_pBinaryIn[9].nSelect = 1;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[9].nSelect = 1;
	}
	else
	{
		m_pBinaryIn[9].nSelect = 0;
		g_theTestCntrFrame->GetBinaryConfig()->m_binIn[9].nSelect = 0;
	}
