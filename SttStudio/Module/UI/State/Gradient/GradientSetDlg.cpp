...
void GradientSetDlg::initUI()
{
	...
	resize(1010,600);
	this->setFixedWidth(1010/*g_theTestCntrFrame->m_pSttFrameConfig->m_nWidth*/);
	this->setFixedHeight(600/*g_theTestCntrFrame->m_pSttFrameConfig->m_nHeight*/);
...
//	disconnect(m_pedtStepTime,SIGNAL(editingFinished()),this,SLOT(slot_StepTimeChanged()));
	...
	GetWidgetBoard_DigitData(4,str,m_pedtStepTime,g_theTestCntrFrame);
