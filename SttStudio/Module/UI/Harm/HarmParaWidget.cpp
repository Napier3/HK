...
//  font.setPointSize(20);
    ...
    m_pEdit_Start = new QSttLineEdit(this);//始值编辑框
    ...
    m_pEdit_End = new QSttLineEdit(this);
    ...
    m_pEdit_Step = new QSttLineEdit(this);//步长编辑框
    ...
    m_pEdit_Steptime = new QSttLineEdit(this);//时间编辑框
...
void QHarmParaWidget::SetHarmOrderCombox()//谐波序列
{
	...
	{
		if (m_pHarmParas->m_uiVOL[0].Harm[nIndex].m_bSelect)
		{
