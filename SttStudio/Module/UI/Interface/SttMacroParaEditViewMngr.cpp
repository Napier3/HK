...
//sun #include "../Webkit/SttMacroParaEditViewHtml.h"
...
//sun void CSttMacroParaEditViewMngr::DeleteSttMacroParaEditViewHtml()
//sun {
//sun 	QSttMacroParaEditViewHtml *pSttMacroParaEditViewHtml = NULL;
//sun 	QSttMacroParaEditViewHtml *pSttMacroParaEditViewHtmlDelete = NULL;
//sun 	pSttMacroParaEditViewHtml = (QSttMacroParaEditViewHtml*)g_pSttMacroParaEditViewMngr->m_pSttMacroParaEditViewHtml;
//sun
//sun 	if (pSttMacroParaEditViewHtml != NULL)
//sun 	{
//sun 		g_pSttMacroParaEditViewMngr->m_pSttMacroParaEditViewHtmlForDelete = pSttMacroParaEditViewHtml;
//sun 		pSttMacroParaEditViewHtml->OpenHtmlFile("");
//sun 		pSttMacroParaEditViewHtml->hide();
//sun 		pSttMacroParaEditViewHtml->deleteLater();
//sun 	}
//sun
//sun 	g_pSttMacroParaEditViewMngr->m_pSttMacroParaEditViewHtmlForDelete = NULL;
//sun 	g_pSttMacroParaEditViewMngr->m_pSttMacroParaEditViewHtml = NULL;
//sun }
...
CSttMacroParaEditInterface* CSttMacroParaEditViewMngr::CreateSttMacroParaEditView(const CString &strMacroID, const CString &strGridFile,BOOL bUseExist)
{
	...
	{
//sun 		QSttMacroParaEditViewGooseAbnormal *pSttMacroParaEditViewGooseAbnormal = new QSttMacroParaEditViewGooseAbnormal(false,false);
//sun 		pNew = pSttMacroParaEditViewGooseAbnormal;
//sun #ifndef SttTestCntrThread_H
//sun 		pSttMacroParaEditViewGooseAbnormal->initUI_Paras(false,false);
//sun #else
//sun 		g_theSttTestCntrThread->PostThreadMessage(4, (unsigned long)pNew, (unsigned long)pNew);
//sun #endif
 	}
	...
	{
        //sun pNew = new QSttMacroParaEditViewSoeWidget;
	}
	...
	{
        //sun pNew = new QSttMacroParaEditViewRemoteMeas;
	}
    ...
    {
        //sun pNew = new QSttMacroParaEditViewAntiShakeTime;
    }
