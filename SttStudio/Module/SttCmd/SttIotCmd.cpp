...
#include "stdafx.h"
#include "SttIotCmd.h"
//sun #include "../../../IotAtsMngr/Module/PxEngineServer/IotPxEngineInterface.h"
...
CSttIotCmd::~CSttIotCmd()
{
    //sun CIotPxCommChannelInterface *pInterface = (CIotPxCommChannelInterface *)GetSttCmmOptrInterface();
    //sun if (pInterface != NULL)
    //sun {
    //sun 	pInterface->FreeCmd(this);
    //sun }
}
...
CSttIotCmd* CSttIotCmdDriver::NewSttIotCmd(void *pCmmInterface)
{
    ...
    //sun CIotPxCommChannelInterface* pInterface = (CIotPxCommChannelInterface *)pCmmInterface;
    //sun pInterface->AddCmd(p);
