...
void stt_xml_serialize(tmt_StatePara &oStatePara, long nIndex, CSttXmlSerializeBase *pXmlSierialize,int nHarmCount)
{
#ifdef NOT_USE_XLANGUAGE
...
tmt_StatePara* stt_state_paras_insert_after(tmt_StateParas *pParas, tmt_StatePara *pSrc, int nAfter)
{
	...
	{
		strcpy(pParas->m_paraState[nIndex].m_strID, pParas->m_paraState[nIndex + 1].m_strID);
	}
