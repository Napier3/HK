...
CDataGroup* QDistanceAddMultDlg::OpenDisTanceParasFile(const CString& strParasFile)
{
    ...
    //sun m_pDistanceparas->OpenXmlFile(stt_ui_GetParasFile(strParasFile), CDataMngrXmlRWKeys::g_pXmlKeys);
...
void QDistanceAddMultDlg::GetDatas(CDataGroup *pParas)
{
    ...
    //sun pParas->SaveXmlFile(stt_ui_GetParasFile(_T("Distance_Paras_Debug.xml")), CDataMngrXmlRWKeys::g_pXmlKeys);
