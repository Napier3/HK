...
long CSttDevConfig::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
	...
	xml_GetElementText(pXmlKeys->m_strHasFT3Key, oNode, m_nHasFT3);
...
long CSttDevConfig::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	...
	xml_SetElementText(pXmlKeys->m_strHasFT3Key, oXMLDoc, oElement, m_nHasFT3);
...
long CSttDevConfig::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
	if(oBinaryBuffer.IsCalSizeMode())
	{
		...
		BinarySerializeCalLen(oBinaryBuffer, m_nHasFT3);
	}
	else if(oBinaryBuffer.IsReadMode())
	{
		...
		BinarySerializeRead(oBinaryBuffer, m_nHasFT3);
	}
	else if(oBinaryBuffer.IsWriteMode())
	{
		...
		BinarySerializeWrite(oBinaryBuffer, m_nHasFT3);
	}
	return 0;
}
