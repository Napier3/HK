...
HKWgtText::HKWgtText(QWidget* pParent)
{
	m_pParent = pParent;
	setParent(pParent);
}
...
void HKWgtText::SetWgtStyle(HKWgtStyle* pStyle)
{
	if(!pStyle)
	{
		return;
    ...
    HKWgtBase::SetWgtStyle(this, pStyle);
...
void HKWgtText::InitUIOwn(CExBaseObject *pSttXuiData)
{
	if (pSttXuiData)
	{
