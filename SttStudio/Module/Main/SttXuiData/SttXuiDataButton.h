...
class CSttXuiDataButton : public CSttXuiDataBase
{
public:
	CSttXuiDataButton();
    ~CSttXuiDataButton() override;

public:
    CString  m_strPic{};
//÷ÿ‘ÿ∫Ø ˝
public:
    UINT GetClassID() override {    return MNGRCLASSID_CSTTXUIDATABUTTON;   }
    BSTR GetXmlElementKey() override {      return CSttXMainConfigXmlRWKeys::CSttXuiDataButtonKey();     }
