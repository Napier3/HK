...
public:
    UINT GetClassID() override {    return MNGRCLASSID_CSTTXUIDATABTNSGROUP;   }
    BSTR GetXmlElementKey() override {      return CSttXMainConfigXmlRWKeys::CSttXuiDataBtnsGroupKey();     }
