...
public:
	...
	virtual long Event_OnTestFinished(CSttParas *pSttParas, BOOL& bState){return 0;}////2024.1.8 yzj 判断test-cmd是错误的，需要判断ats-cmd，新增BOOL&改变ats下的状态
	...
	virtual long Event_OnSearchPointReport(CSttParas *pSttParas){return 0;}//zhouhj 20210925新增用于返回测试点报告
	virtual long Event_OnSearchPointFinish(CSttParas *pSttParas){return 0;}
	virtual long Event_OnExportRpt(CSttParas *pSttParas){return 0;}  //shaolei 20220718  导出报告事件
...
public:
    ...
    virtual long OnRtData(CSttParas *pParas){return 0;}//实时数据处理
...
public:
	...
	virtual long OnConnectStateChanged(bool bState){	 return 0;	} //sf 20220225 连接状态改变 
	virtual long OnItemStateChanged(const CString &strTestID, long nDeviceIndex, long nReportIndex, long nItemIndex, const CString & strItemID, long nState, CSttParas *pParas) = 0;
	virtual long OnTestFinished(const CString &strTestID, long nDeviceIndex, long nReportIndex, CSttParas *pParas) = 0;
