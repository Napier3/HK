...
BOOL CSttAtsTestClient::ConnectAtsTestServer(const CString &strIP,long nPort,const CString &strSoftID)
{
	...
	xlang_GetLangStrByFile(strText, "Native_ConnectingTester");
	xlang_GetLangStrByFile(strText1, "Native_TesterConnectSucc");
	xlang_GetLangStrByFile(strText2, "Native_TesterConnectfail");
									  ...
									  ,const CString &strDvmFile, const CString &strPpXmlFile,long nTestMode)
{
	...
	return m_pXClientEngine->Ats_StartTest(pTestMacroUI, pUIParas, pCommCmd, pCharacteristic, bDoEvents, pRetData,strDvmFile,strPpXmlFile, nTestMode);
}
											 ...
											 ,bool bDoEvents,CSttCmdData *pRetData,const CString &strDvmFile,const CString &strPpXmlFile)
{
	...
	return m_pXClientEngine->Ats_GenerateTemplate(pTestMacroUI, pUIParas, pCommCmd, pCharacteristic, strRetMode, nHasDigital, bDoEvents, pRetData,strDvmFile,strPpXmlFile);
}
...
void CSttAtsTestClient::Ats_IecDetect(long bEnable)
{
	...
	oGroup.AddNewData(_T("IecType"), m_nIecType);
