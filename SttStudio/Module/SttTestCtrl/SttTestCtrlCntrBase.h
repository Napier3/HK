...
// 		long nPowerAC, long nBatCap ,long nUSB){	return 0; };
	...
	virtual void OnAtsQueryItem(CExBaseObject *pItemPara) = 0;  //2022-9-13  Eric
...
public:
  ...
  virtual void FillReport(CSttReports *pSttReports){}
    ...
    virtual CExBaseList *GetReports(){ return nullptr; }
	virtual void GetEventInfo(CExBaseList& oInfoList){};
    virtual CExBaseList* GetTestGlobalParas(){return nullptr;}//zhouhj 20220913 增加用于获取短路、过载、过热等状态
...
protected:
	...
	CSttMacroTestUI_TestMacroUI *m_pCurrTestMacroUI;  //2022-3-11  Eric  for debug
...
public:
	...
	virtual long Ats_GenerateItems(const CString &strItemParentPath, const CString &strItemsName, const CString &strItemsID
        , CDataGroup *pCommCmd=nullptr, const CString &strDvmFile=_T(""), const CString strTestClass=_T(""), long nRepeatTimes=1
