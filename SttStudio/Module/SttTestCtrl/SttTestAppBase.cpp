...
QRingMemBufShmDebugWidget *g_pRingMemBufShmDebugWidget = nullptr;
...
CSttTestAppBase *g_pTheSttTestApp = nullptr;
...
CSttTestAppBase::~CSttTestAppBase()
{
    ...
    if (m_pDvmDevice != nullptr)
	{

	}
}

//sun #include <QtWebKit>
...
void CSttTestAppBase::ExitSttTestApp()
{
    ...
    //sun CDeviceModelXmlKeys::Release();
...
void CSttTestAppBase::SetSttTestCtrlCntr(CSttTestCtrlCntrBase *pTestCtrlCntr)
{
    ...
    //sun if (g_theGbWzdAiTool != nullptr)
    //sun {
    //sun 	g_theGbWzdAiTool->SetSttGuideBook((CSttGuideBook*)pTestCtrlCntr->GetGuideBook());
    //sun }
}
...
void CSttTestAppBase::ExitSttIecRecord()
{
    ...
    g_pRingMemBufShmDebugWidget = nullptr;
#endif
}
...
//	CLogPrint::LogFormatString(XLOGLEVEL_RESULT,"(%s)(%s).",strPath.GetString(),strFile.GetString());
    ...
    //sun if (g_theGbWzdAiTool != nullptr)
    //sun {
    //sun 	g_theGbWzdAiTool->SetDvmDevice(m_pDvmDevice);
    //sun 	g_theGbWzdAiTool->DvmFilterByExtendKeys();
    //sun }
}
