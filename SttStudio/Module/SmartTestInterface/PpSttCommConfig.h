...
public:
  ...
  void Serial_Set_port_number(long nPortNumber);
    ...
    //sun void TcpClient_Set_LocalIP(const CString &strLocalIP);
    //sun void TcpClient_Set_LocalPort(long nLocalPort);
    //sun void TcpClient_Set_RemoteIP(const CString &strRemoteIP);
    //sun void TcpClient_Set_RemotePort(long nRemotePort);
    ...
    //sun CString  TcpClient_Get_RemotePort();
    //sun CString  TcpClient_Get_RemoteIP();
    //sun CString  TcpClient_Get_LocalPort();
    //sun CString  TcpClient_Get_LocalIP();
    //sun
    //sun CString  TcpServer_Get_LocalPort();
    //sun CString  TcpServer_Get_LocalIP();
    //sun
    //sun CString  UdpServer_Get_MuticastIP();
    //sun CString  UdpServer_Get_LocalPort();
    //sun CString  UdpServer_Get_LocalIP();
    //sun
    //sun CString  UdpClient_Get_RemotePort();
    //sun CString  UdpClient_Get_RemoteIP();
    //sun CString  UdpClient_Get_LocalPort();
    //sun CString  UdpClient_Get_LocalIP();
    //sun CString  UdpClient_Get_MuticastIP();
    //sun
    //sun CString  Serial_Get_port_number();
    //sun CString  Serial_Get_baud_rate();
    //sun CString  Serial_Get_byte_size();
    //sun CString  Serial_Get_stop_bit();
    //sun CString  Serial_Get_parity();
    //sun
    //sun CString MMS_Get_RemoteIP();
    //sun CString MMS_Get_LocalIP();
    //sun CString MMS_Get_EncryptKey();
    //sun CString MMS_Get_EncryptPsw();
    //sun
    //sun CString CMS_Get_LocalIP();
    //sun CString CMS_Get_EncryptKey();
    //sun CString CMS_Get_EncryptPsw();
    //sun CString CMS_Get_RemoteIP();
    //sun CString CMS_Get_RemotePort();
