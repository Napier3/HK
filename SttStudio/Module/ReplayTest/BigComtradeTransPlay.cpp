...
BOOL CBigComtradeTransPlay::CreateSttComtradeSocket()
{
    ...
    CString_to_char(m_pSttTestAppCfg->GetTestAppIP(),pszIPServer);
    BOOL bRet = m_oComtradeClientSocket.ConnectServer(pszIPServer, STT_PORT_COMTRADE_SERVER/*g_oSttTestAppCfg.GetTestServerPort()*/);
