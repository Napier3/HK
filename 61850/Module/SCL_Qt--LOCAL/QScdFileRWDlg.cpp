...
: QProgressDialog(pParent)
{
	...
	connect(this, SIGNAL(sig_SetTitle(const CString&)), this, SLOT(slot_SetTitle(const CString&)), Qt::BlockingQueuedConnection);
	connect(this, SIGNAL(sig_SetMaxRange(long)), this, SLOT(slot_SetMaxRange(long)), Qt::BlockingQueuedConnection);
	connect(this, SIGNAL(sig_ResetProcess()), this, SLOT(slot_ResetProcess()), Qt::BlockingQueuedConnection);
	connect(this, SIGNAL(sig_StepIt()), this, SLOT(slot_StepIt()), Qt::BlockingQueuedConnection);
	connect(this, SIGNAL(sig_ShowMsg(const CString&)), this, SLOT(slot_ShowMsg(const CString&)), Qt::BlockingQueuedConnection);
	connect(this, SIGNAL(sig_StartTimer(long)), this, SLOT(slot_StartTimer(long)), Qt::BlockingQueuedConnection);
	connect(this, SIGNAL(sig_InitThreadProgress(long, long)), this, SLOT(slot_InitThreadProgress(long, long)), Qt::BlockingQueuedConnection);
}
