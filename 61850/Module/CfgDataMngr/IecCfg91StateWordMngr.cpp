...
{
	//初始化属性
    m_pStateWord = nullptr;
    m_pStDataTypeMngr = nullptr;
...
long CIecCfg91StateWordMngr::XmlReadChildren(CXmlRWNodeListBase &oNodes, CXmlRWKeys *pXmlRWKeys)
{
    ...
    CXmlRWNodeBase *pNode = nullptr;
    //MSXML2::IXMLDOMNodePtr oNode = nullptr;
	CString strNodeName;
