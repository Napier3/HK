...
#define SLOGIPC_SMRT_HDR_SIZE   (3 * sizeof (ST_UINT32))
#define SLOGIPC_HDR_PARAM_SIZE  sizeof (ST_UINT32)
#define SLOGIPC_MSG_TYPE_SIZE   sizeof (ST_UINT32)
...
typedef struct ipc_log_ctrl_tag
  ...
  ST_VOID (*slog_ipc_cmd_fun) (struct tag_GEN_SOCK *pSock, struct tag_GEN_SOCK_DATA *sockData,
			       ST_UINT32 msgType, ST_UINT32 msgDataLen, ST_CHAR *msgData); 
...
ST_VOID slog_ipc_std_cmd_fun (struct tag_GEN_SOCK *pSock, 
			      struct tag_GEN_SOCK_DATA *sockData,
...
ST_VOID log_printf( SD_CONST ST_CHAR *format, ...);
