...
/* #include "suicacse.h" */
/* If MAP30_ACSE is defined, suicacse.h includes lber.h defining sockbuf*/
/* that conflicts with /usr/include/sys/socketvar.h on AIX. 		*/
...
/* LLP logging */
ST_VOID m_log_mllp_assoc_req (ACSE_AR_INFO *info);
ST_VOID m_log_mllp_a_assoc_conf (ACSE_AR_INFO *info);
ST_VOID m_log_llp_error_req (ST_VOID);
