...
/*	this is how we distinguish between TP0 and TP4 connections.	*/
/************************************************************************/
...
ACSE_CONN *acse_conn; 
  ...
  tp_conn = &tp0_conn_arr [acse_conn->idx];
  conn_id = acse_conn->idx;
  ...
  memcpy (tpdu_cr->loc_tsap, only_tp0_loc_tsap, only_tp0_loc_tsap [0]+1);
