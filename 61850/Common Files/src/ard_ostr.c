...
#ifdef GET_CONSTRUCTED_OSTRINGS
...
/************************************************************************/
ST_RET asn1r_get_octstr_fixlen (ASN1_DEC_CTXT *aCtx, ST_CHAR *ptr, ST_INT len)
  {
ST_RET retcode;
...
/************************************************************************/
ST_RET asn1r_get_octstr_varlen (ASN1_DEC_CTXT *aCtx, ST_CHAR *ptr, ST_INT maxlen, ST_INT *lenout)
  {
ST_RET retcode;
...
#endif /* #ifdef GET_CONSTRUCTED_OSTRINGS */
  }
