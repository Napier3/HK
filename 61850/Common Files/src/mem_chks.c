...
ST_BOOLEAN g_bUseSmemEnable = TRUE;

#if defined(DEBUG_SISCO)
ST_VOID *M_MALLOC (ST_VOID *ctxPara, ST_UINT size)
{
	if (g_bUseSmemEnable)
	{
		return x_m_malloc(ctxPara,size,  thisFileName,__LINE__);
	} 
	else
	{
		return x_chk_malloc(size,  thisFileName,__LINE__);
	}
}

ST_VOID *M_CALLOC (ST_VOID *ctxPara, ST_UINT num, ST_UINT size)
{
	if (g_bUseSmemEnable)
	{
		return x_m_calloc(ctxPara,num,size,  thisFileName,__LINE__);
	} 
	else
	{
		return x_chk_calloc(num,size,  thisFileName,__LINE__);
	}
}

ST_VOID *M_REALLOC (ST_VOID *ctxPara, ST_VOID *old, ST_UINT size)
{
	if (g_bUseSmemEnable)
	{
		return x_m_realloc(ctxPara,old,size,  thisFileName,__LINE__);
	} 
	else
	{
		return x_chk_realloc(old,size,  thisFileName,__LINE__);
	}
}

ST_CHAR *M_STRDUP (ST_VOID *ctxPara, ST_CHAR *str)
{
	if (g_bUseSmemEnable)
	{
		return x_m_strdup(ctxPara,str,  thisFileName,__LINE__);
	} 
	else
	{
		return x_chk_strdup(str,  thisFileName,__LINE__);
	}
}

ST_VOID M_FREE (ST_VOID *ctxPara, ST_VOID *ptr)
{
	if (g_bUseSmemEnable)
	{
		return x_m_free(ctxPara,ptr,  thisFileName,__LINE__);
	} 
	else
	{
		return x_chk_free(ptr,  thisFileName,__LINE__);
	}
}

ST_VOID *chk_malloc (ST_UINT size)
{
	if (g_bUseSmemEnable)
	{
		return x_m_malloc(MSMEM_GEN,size,  thisFileName,__LINE__);
	} 
	else
	{
		return x_chk_malloc(size,  thisFileName,__LINE__);
...
ST_VOID *chk_calloc(ST_UINT num, ST_UINT size)
{
	if (g_bUseSmemEnable)
	{
		return x_m_calloc(MSMEM_GEN,num,size,  thisFileName,__LINE__);
	} 
	else
	{
		return x_chk_calloc(num,size,  thisFileName,__LINE__);
...
ST_VOID *chk_realloc (ST_VOID *old, ST_UINT size)
{
	if (g_bUseSmemEnable)
	{
		return x_m_realloc(MSMEM_GEN,old,size,  thisFileName,__LINE__);
	} 
	else
	{
		return x_chk_realloc(old,size,  thisFileName,__LINE__);
...
ST_CHAR *chk_strdup (ST_CHAR *str)
{
	if (g_bUseSmemEnable)
	{
		return x_m_strdup(MSMEM_GEN,str,  thisFileName,__LINE__);
	} 
	else
	{
		return x_chk_strdup(str,  thisFileName,__LINE__);
...
ST_VOID chk_free (ST_VOID *ptr)
{
	if (g_bUseSmemEnable)
	{
		return x_m_free(MSMEM_GEN,ptr,  thisFileName,__LINE__);
	} 
	else
	{
		return x_chk_free(ptr,  thisFileName,__LINE__);
...
ST_VOID *M_MALLOC (ST_VOID *ctxPara, ST_UINT size)
{
	if (g_bUseSmemEnable)
	{
		return nd_m_malloc(ctxPara,size);
	} 
	else
	{
		return nd_chk_malloc(size);
	}
}
...
ST_VOID *M_CALLOC (ST_VOID *ctxPara, ST_UINT num, ST_UINT size)
{
	if (g_bUseSmemEnable)
	{
		return nd_m_calloc(ctxPara,num,size);
	} 
	else
	{
		return nd_chk_calloc(num,size);
	}
}
...
ST_VOID *M_REALLOC (ST_VOID *ctxPara, ST_VOID *old, ST_UINT size)
{
	if (g_bUseSmemEnable)
	{
		return nd_m_realloc(ctxPara,old,size);
	} 
	else
	{
		return nd_chk_realloc(old,size);
	}
}
...
ST_CHAR *M_STRDUP (ST_VOID *ctxPara, ST_CHAR *str)
{
	if (g_bUseSmemEnable)
	{
		return nd_m_strdup(ctxPara,str);
	} 
	else
	{
		return nd_chk_strdup(str);
	}
}
...
ST_VOID M_FREE (ST_VOID *ctxPara, ST_VOID *ptr)
{
	if (g_bUseSmemEnable)
	{
		return nd_m_free(ctxPara,ptr);
	} 
	else
	{
		return nd_chk_free(ptr);
	}
}
...
ST_VOID *chk_malloc (ST_UINT size)
{
	if (g_bUseSmemEnable)
	{
		return nd_m_malloc(MSMEM_GEN,size);
	} 
	else
	{
		return nd_chk_malloc(size);
...
ST_VOID *chk_calloc(ST_UINT num, ST_UINT size)
{
	if (g_bUseSmemEnable)
	{
		return nd_m_calloc(MSMEM_GEN,num,size);
	} 
	else
	{
		return nd_chk_calloc(num,size);
...
ST_VOID *chk_realloc (ST_VOID *old, ST_UINT size)
{
	if (g_bUseSmemEnable)
	{
		return nd_m_realloc(MSMEM_GEN,old,size);
	} 
	else
	{
		return nd_chk_realloc(old,size);
...
ST_CHAR *chk_strdup (ST_CHAR *str)
{
	if (g_bUseSmemEnable)
	{
		return nd_m_strdup(MSMEM_GEN,str);
	} 
	else
	{
		return nd_chk_strdup(str);
...
ST_VOID chk_free (ST_VOID *ptr)
{
	if (g_bUseSmemEnable)
	{
		return nd_m_free(MSMEM_GEN,ptr);
	} 
	else
	{
		return nd_chk_free(ptr);
...
// 
//lijq 2015-1-17
 /*static*/ CHK_DYN_MEM_NODE *head_dyn_mem_list = NULL;
...
#endif	/* no debug, do nothing. Can't log_printf because may be windowing. */
...
DWORD bytesWritten;
  ...
  *retVal = 0;
  ...
  hFile = CreateFile("MemReport.log", GENERIC_WRITE, 
