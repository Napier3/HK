...
#define SERV0	STATUS_SSI   | GETNAMES_SSI | IDENT_SSI    | RENAME_SSI   | \
	        READ_SSI     | WRITE_SSI    | GETVAR_SSI   | DEFVAR_SSI   //   20200903 zhouhj  DEFVAR_SSI 对应初始化时的  defineNamedVariable (7)

#define SERV1	DEFSCAT_SSI  | GETSCAT_SSI  | DELVAR_SSI   | DEFVLIST_SSI | \
		GETVLIST_SSI | DELVLIST_SSI | DEFTYPE_SSI  | GETTYPE_SSI  ////20200903 zhouhj  DEFSCAT_SSI对应  defineScatteredAccess (8)  DELVAR_SSI 对应初始化时的  deleteVariableAccess (10) 
