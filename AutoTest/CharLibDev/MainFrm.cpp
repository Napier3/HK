...
void CMainFrame::InitializeRibbon()
{
	...
	CMFCRibbonCategory* pCategoryHome = m_wndRibbonBar.AddCategory(CXLanguageResourceAts_CharLibDev::g_sLangTxt_CharCurveOprt/*_T("特性曲线操作")*/, IDB_WRITESMALL, IDB_WRITELARGE);

	CMFCRibbonPanel* pPane = pCategoryHome->AddPanel(CXLanguageResourceAts_CharLibDev::g_sLangTxt_CurveOprt/*_T("曲线操作")*/, m_PanelImages.ExtractIcon(27));
	CMFCRibbonButton* pBtn = NULL;
	
	pBtn = new CXLangRibbonButton(ID_CHAROPTR_NEWCHAR, CXLanguageResourceAts_CharLibDev::g_sLangTxt_NewCurve/*_T("新建曲线")*/,CXLanguageResourceAts_CharLibDev::g_sLangTxt_NewCurveTip, 0, 0);
	pPane->Add(pBtn);
	...
	pPane->Add(pBtn);
	pBtn = new CXLangRibbonButton(ID_CHAROPTR_SAVE, CXLanguageResourceAts_CharLibDev::g_sLangTxt_SaveCurve/*_T("保存曲线")*/,CXLanguageResourceAts_CharLibDev::g_sLangTxt_SaveCurveTip, 1, 1);
	pPane->Add(pBtn);
	pBtn = new CXLangRibbonButton(ID_CHAROPTR_SAVEAS,  CXLanguageResourceAts_CharLibDev::g_sLangTxt_SaveAsCurve/*_T("曲线另存为")*/,CXLanguageResourceAts_CharLibDev::g_sLangTxt_SaveAsCurveTip, 2, 2);
	pPane->Add(pBtn);
	pBtn = new CXLangRibbonButton(ID_CHAROPTR_DELETE, CXLanguageResourceAts_CharLibDev::g_sLangTxt_DeleteCurve/*_T("删除曲线")*/,CXLanguageResourceAts_CharLibDev::g_sLangTxt_DeleteCurveTip, 3, 3);
	pPane->Add(pBtn);
	pBtn = new CXLangRibbonButton(ID_CHAROPTR_EXPORT, CXLanguageResourceAts_CharLibDev::g_sLangTxt_ExportCurve/*_T("导出曲线")*/,CXLanguageResourceAts_CharLibDev::g_sLangTxt_ExportCurveTip, 4, 4);
	pPane->Add(pBtn);
	pBtn = new CXLangRibbonButton(ID_CHAROPTR_EDIT,  CXLanguageResourceAts_CharLibDev::g_sLangTxt_ModifyCurve/*_T("修改曲线")*/,CXLanguageResourceAts_CharLibDev::g_sLangTxt_ModifyCurveTip, 7, 7);
	pPane->Add(pBtn);

	pPane = pCategoryHome->AddPanel(CXLanguageResourceAts_CharLibDev::g_sLangTxt_View/*_T("视图")*/, m_PanelImages.ExtractIcon(27));
	pBtn = new CXLangRibbonCheckBox(ID_VIEW_CHARPANE, CXLanguageResourceAts_CharLibDev::g_sLangTxt_CurveBar/*_T("曲线栏")*/,CXLanguageResourceAts_CharLibDev::g_sLangTxt_CurveBarTip);
	pPane->Add(pBtn);
	pBtn = new CXLangRibbonCheckBox(ID_VIEW_OUTPUTWND, CXLanguageResourceAts_CharLibDev::g_sLangTxt_OutputBar1/*_T("输出栏")*/,CXLanguageResourceAts_CharLibDev::g_sLangTxt_OutputBar1Tip);
	pPane->Add(pBtn);

	pPane = pCategoryHome->AddPanel(CXLanguageResourceAts_CharLibDev::g_sLangTxt_HelpAbout /*_T("关于")*/, m_PanelImages.ExtractIcon(27));
	pBtn = new CXLangRibbonButton(ID_APP_ABOUT,CXLanguageResourceAts_CharLibDev::g_sLangTxt_About1 /* _T("关于")*/,CXLanguageResourceAts_CharLibDev::g_sLangTxt_About1Tip, 5, 5);
	pPane->Add(pBtn);
	pBtn = new CXLangRibbonButton(ID_APP_EXIT, CXLanguageResourceAts_CharLibDev::g_sLangTxt_Exit1/*_T("退出")*/,CXLanguageResourceAts_CharLibDev::g_sLangTxt_Exit1Tip, 6, 6);
	pPane->Add(pBtn);
...
{
	CCharEditDlg dlg;
	dlg.m_strTitle = CXLanguageResourceAts_CharLibDev::g_sLangTxt_ModifyCharCurve/*_T("修改特性曲线")*/;
...
void CMainFrame::OnClose()
{
	...
	int nRet = MessageBox(CXLanguageResourceAts_CharLibDev::g_sLangTxt_CharCurveSave/*_T("特性曲线库已经被修改，是否保存修改？")*/,CXLanguageResourceAts_CharLibDev::g_sLangTxt_Message1/*_T("提示")*/,MB_YESNOCANCEL|MB_ICONQUESTION);
...
void CMainFrame::OnCharoptrImportfromriofile()
{
	...
	dlgEdit.m_strTitle = CXLanguageResourceAts_CharLibDev::g_sLangTxt_ModifyCharCurve/*_T("修改特性曲线")*/;
