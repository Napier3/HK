...
void CDlgCharElement::xlang_InitAndAdjust()
{
	...
	m_wndEdgeElementType.SetLanguageID(CXLanguageResourceAts_CharLibDev::g_sLangID_EdgeElementType);
    m_wndErrorBandLength.SetLanguageID(CXLanguageResourceAts_CharLibDev::g_sLangID_ErrorBandLength);
    m_wndEdgTestPoints.SetLanguageID(CXLanguageResourceAts_CharLibDev::g_sLangID_EdgTestPoints);
	...
	xlang_InitByLgugStr(CXLanguageResourceAts_CharLibDev::g_sLangID_CharCurveEdge, this);
}
...
// 	}
	...
	{
		MessageBox(CXLanguageResourceAts_CharLibDev::g_sLangTxt_ElementDevelop/*_T("元素开发中.....")*/, CXLanguageResourceAts_CharLibDev::g_sLangTxt_Message1/*_T("提示")*/, MB_OK | MB_ICONWARNING);
		pDlgBase = NULL;
	}
