...
int COutputWnd::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	// 将列表窗口附加到选项卡:
	m_wndTabs.AddTab(&m_wndOutputDebug,CXLanguageResourceAts_CharLibDev::g_sLangTxt_OutPut/* _T("输出")*/, (UINT)1);
...
void COutputList::LogString(long nLevel, const CString &strMsg)
{
	...
	{
		long nIndex=0;
		for (nIndex=0; nIndex<nCount-2000; nIndex++)
		{
			DeleteString(0);
		}
	}
...
{
	MessageBox(CXLanguageResourceAts_CharLibDev::g_sLangTxt_CopyOutPut/*_T("复制输出")*/);
}

void COutputList::OnEditClear()
{
	MessageBox(CXLanguageResourceAts_CharLibDev::g_sLangTxt_ClearOutPut/*_T("清除输出")*/);
}
