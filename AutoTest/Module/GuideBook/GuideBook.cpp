...
void CGuideBook::CalChildrenSize(BOOL bCalChild, long &nObjCount, long &nTotalSize, CFile *pFile)
{
	...
	{
#ifdef _DEBUG
		m_pItemContainer->m_strName.Format(_T("%s:ItemContainer"), m_strName);
		m_pItemContainer->m_strID.Format(_T("%s:ItemContainer"), m_strID);
#endif
	...
	{
#ifdef _DEBUG
		m_pScriptLibGlobal->m_strName.Format(_T("%s:ScriptLibGlobal"), m_strName);
		m_pScriptLibGlobal->m_strID.Format(_T("%s:ScriptLibGlobal"), m_strID);
#endif
	...
	{
#ifdef _DEBUG
		m_oGbCommCmdConfig.m_strName.Format(_T("%s:GbCommCmdConfig"), m_strName);
		m_oGbCommCmdConfig.m_strID.Format(_T("%s:GbCommCmdConfig"), m_strID);
#endif
