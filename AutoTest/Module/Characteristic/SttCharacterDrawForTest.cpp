...
CCharElementTestLine*  CSttCharacterDrawForTest::UpdateMacroTest(CExBaseObject *pMacroTest, CSttReport *pReport)
{
// 	CMacroCharItems *pMacroCharItems = (CMacroCharItems*)pMacroTest->GetParent();
// 	CCharElementTestLine *pCharElementTestLine = pMacroCharItems->UpdateMacroTest(pMacroTest, pReport);
// 
// 	//更新动作点
// 	InitCharacterDrawView(m_pCharacteristic);
// 
// 	return pCharElementTestLine;
	return NULL;
}
