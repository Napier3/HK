...
long CCharElementArcd::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CCharElementArcd::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
...
long CCharElementArcd::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
{
	CString str;
    str.Format(_T("lined x-c=\"%s\" y-c=\"%s\" angle-b=\"%s\" angle-e=\"%s\" radius=\"%s\" ")
               ,m_strXc.GetString(),m_strYc.GetString(),m_strAngleB.GetString()
               ,m_strAngleE.GetString(), m_strRadius.GetString());
	return str;
}

void CCharElementArcd::Draw(CDC *pDC)
{
}


CXDrawBase* CCharElementArcd::CreateDrawElement()
{	
// 	if (m_pDataRef != NULL)
// 	{
...
CXDrawDataBase* CCharElementArcd::GetCXDrawDataBase()
{
	return this;
}
