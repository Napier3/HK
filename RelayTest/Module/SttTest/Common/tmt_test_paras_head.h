...
CString stt_get_test_item_name(PTMT_PARAS_HEAD pParas);	 获取测试点的名字

void stt_clone_expr_mngr(TMT_PARAS_RSLT_EXPR_MNGR pSrc, TMT_PARAS_RSLT_EXPR_MNGR pDest);  克隆表达式
void stt_clone_expr_mngr(PTMT_PARAS_HEAD pSrc, PTMT_PARAS_HEAD pDest);

 zhoulei zhouhongjun shefu
