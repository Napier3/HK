#include "stdafx.h"
#include "SttDisTanceSearchTest.h"
...
CString CSttDisTanceSearchTest::m_strMacroName = "距离保护动作阻抗搜索";
CString CSttDisTanceSearchTest::m_strMacroID = STT_MACRO_ID_DistanceSearch;
CString CSttDisTanceSearchTest::m_strFilePostFix = "odss";
CString CSttDisTanceSearchTest::m_strMacroVer ="1.0";

CSttDisTanceSearchTest::CSttDisTanceSearchTest() : CSttDisTanceTest()
{
...
void CSttDisTanceSearchTest::Init()
{ 
...
CSttDisTanceSearchTest::~CSttDisTanceSearchTest(void)
{

}

void CSttDisTanceSearchTest::AfterSetParameter()
{
	m_oParas.InitSearch();
...
long CSttDisTanceSearchTest::CalReport(UINT nState)
{
	CSttDisTanceTest::CalReport(nState);
...
void CSttDisTanceSearchTest::Para_XmlSerialize(CSttXmlSerializeBase *pXmlSerialize)
{
	...
	if (stt_xml_serialize_is_read(pXmlSerialize))
	{
		...
		m_pImpBaseParas->m_fImpBaseStopTime = 0.005;
...
void CSttDisTanceSearchTest::SearchReport_XmlSerialize(CSttXmlSerializeBase *pXmlSerialize)
{
	stt_xml_serialize_SearchReport(&m_oParas, pXmlSerialize);
}

void CSttDisTanceSearchTest::Report_XmlSerialize(CSttXmlSerializeBase *pXmlSerialize)
{
	stt_xml_serialize_Search(&m_oDistanceSearchResults, pXmlSerialize,g_nBinExCount,g_nBoutExCount);
}

long CSttDisTanceSearchTest::SetParameter(DWORD dwState)
{
	return 0;
}

void CSttDisTanceSearchTest::TranslateToStateParas()
{
#ifdef USE_COMPLEX_SEARCH_MODE
...
void CSttDisTanceSearchTest::SetStateParas_StopTest(tmt_StatePara *pStatePara,tmt_ImpedanceParas *pImpParas,Complex *pVol_Complex,Complex *pCur_Complex,float fStdLN_Vol)
{
...
void CSttDisTanceSearchTest::ReturnTestStateEvent_SearchPoint(double dTime, double dRealTime, bool bWithEvent)
{
#ifdef USE_COMPLEX_SEARCH_MODE
...
// 			m_oParas.m_fCurrScanVal,m_oParas.m_fCurrScanValAngle);
		...
		drv_reg_ioctl(__FILE__, __LINE__, nFd,0x14A,0);
...
void CSttDisTanceSearchTest::ReturnTestStateEvent_TestStart(double dTime, double dRealTime, bool bWithEvent)
{
	STT_TIME oTime;
	oTime.dRealTime = dRealTime;
	oTime.dTime = dTime;
...
#ifndef USE_COMPLEX_SEARCH_MODE
BOOL CSttDisTanceSearchTest::ActProcess(float fTime)
{
...
BOOL CSttDisTanceSearchTest::CalNext()
{
	CSttDisTanceTest::AfterSetParameter();
	m_oParas.SearchNext();
