...
void stt_xml_serialize(PTMT_ADJUST_THREE_RESULTS pPara, CSttXmlSerializeBase *pXmlSerialize)
{
	...
	pXmlSerialize->xml_serialize("通道1零漂","Zero1","","double",pPara->m_oResult[0].m_fZero);
	...
	pXmlSerialize->xml_serialize("通道2零漂","Zero2","","double",pPara->m_oResult[1].m_fZero);
	...
	pXmlSerialize->xml_serialize("通道3零漂","Zero3","","double",pPara->m_oResult[2].m_fZero);
