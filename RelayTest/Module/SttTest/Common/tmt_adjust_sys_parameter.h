...
#define STT_ADJUST_MODULE_PARA_VERSION		STT_ADJUST_MODULE_PARA_VERSION_4
#ifdef _PSX_IDE_QT_
...
#define ADJUST_MAX_CH_MAPS_COUNT        12
  ...
  因为外部需要访问，所以将模块属性定义部分放到  tmt_adjust_sys_para_module_def.h
...
{//用short 、 char，节省空间
	...
	float m_fTotalCurAmp;//临时记录通道的电流总幅值
