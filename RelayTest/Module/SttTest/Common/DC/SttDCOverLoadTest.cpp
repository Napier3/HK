#include "stdafx.h"
#include"SttDCOverLoadTest.h"

CString CSttDCOverLoadTest::m_strMacroName = "柔直过负荷测试";
CString CSttDCOverLoadTest::m_strMacroID = STT_MACRO_ID_DCOverLoadTest;
CString CSttDCOverLoadTest::m_strFilePostFix = "stttst";
CString CSttDCOverLoadTest::m_strMacroVer = "1.0";

CSttDCOverLoadTest::CSttDCOverLoadTest()
{
...
CSttDCOverLoadTest::~CSttDCOverLoadTest(void)
{
}

void CSttDCOverLoadTest::AfterSetParameter()
{
...
long CSttDCOverLoadTest::CalReport(UINT nState)
{
...
void CSttDCOverLoadTest::Para_XmlSerialize(CSttXmlSerializeBase *pXmlSerialize)
{
...
void CSttDCOverLoadTest::Report_XmlSerialize(CSttXmlSerializeBase *pXmlSerialize)
{
    stt_xml_serialize(&m_oOverLoadTestResults, pXmlSerialize);
}

void CSttDCOverLoadTest::StartTest()
{
    if(GetTestStarting())
    {
...
void CSttDCOverLoadTest::TtmToDrv()
{
#ifdef _PSX_QT_LINUX_
