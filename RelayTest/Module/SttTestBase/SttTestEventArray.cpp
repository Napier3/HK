...
void stt_xml_serialize_test_events(PSTT_TEST_EVENT pEvent, CSttXmlSerializeBase *pXmlSerialize)
{
	...
	for(int nEventIndex=0;nEventIndex<pEvent->nEventInfoCnt && nEventIndex<MAX_ExBINARY_COUNT;nEventIndex++)
	{
