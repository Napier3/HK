...
public:
    ...
    virtual void SetParas(CDataGroup *pParas);
...
//	virtual void ReadParas(CXmlRWNodeBase &oNode, BSTR bstrParasKey);
	...
	CTestBaseInterface* GetTestBaseInterface();

    
    CDataGroup* ToDataGroup();
    void ToDataGroup(CDataGroup *pDataGroup);

protected:
    void InitPara(CExBaseObject *pDestPara, CExBaseObject *pSrcPara);
};
