...
protected:
	...
	CXmlRWElementBase* FindElement(BSTR bstrElementKey, long nIndex);  
	CXmlRWElementBase* FindElement(BSTR bstrElementKey, BSTR bstrAttrID, const char *pszAttrValue,   long nIndex);  
