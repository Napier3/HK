...
extern long g_nParaRegisterDescInfor;// = FALSE;
#define REGSTER_MODE_ALL                  0
#define REGSTER_MODE_NO_NAME       1
#define REGSTER_MODE_NAME_EQ_ID   2
...
public:
    ...
    CSttParaObject(const char *pszName,const char *pszID,const char *pszUnit,const char *pszDataTypeID,const char *pszDefaultValue, VAR_DOUBLE_LIST *val);
    CSttParaObject(const char *pszName,const char *pszID,const char *pszUnit,const char *pszDataTypeID,const char *pszDefaultValue, VAR_FLOAT_LIST *val);
    CSttParaObject(const char *pszName,const char *pszID,const char *pszUnit,const char *pszDataTypeID,const char *pszDefaultValue, VAR_INT_LIST *val);
