...
#include "../SttSocket/SttXcmdChInterface.h"
...
long CSttCmdBase::DoWait(CSttXcmdChInterface *pSocket,STT_CMD_INFO *pCmdInfo,long nTimeOut,CSttCmdData *pRetData,BOOL bDoEvents)
{
...
// 	}
	...
	while(TRUE)
	{
			...
			|| pCmdInfo->IsCmdExecState_Success())
		{
			...
			{
// 				CSttParas *pSttParas = (CSttParas*)pCmdInfo->pSysState->FindByClassID(STTCMDCLASSID_CSTTPARAS);
// 
// 				if (pSttParas != NULL)
// 				{
// 					CLogPrint::LogFormatString(XLOGLEVEL_INFOR,_T("[B]DoWait[%ld][%ld][%ld]"),pSttParas->GetCount(),(long)pCmdInfo->pSysState,pSttParas);
// 				}
...
// 				pSttParas = (CSttParas*)pRetData->FindByClassID(STTCMDCLASSID_CSTTPARAS);
// 
// 				if (pSttParas != NULL)
// 				{
// 					CLogPrint::LogFormatString(XLOGLEVEL_INFOR,_T("[A]DoWait[%ld][%ld][%ld]"),pSttParas->GetCount(),(long)pCmdInfo->pSysState,pSttParas);
// 				}
			}
