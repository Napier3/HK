...
#ifndef STT_CMD_PARAS_NOT_USE_TEST  
...
void CSttParas::InitAfterRead()
{
    ...
    while (pos != NULL)
    {
       ...
       case DVMCLASSID_CDVMDATASETGROUP:
          break;

#ifndef STT_CMD_PARAS_NOT_USE_TEST  
           case STTCMDCLASSID_REPORTS:
                break;

           case STTCMDCLASSID_CSTTRPTMAPDATAS:
           break;

           case STTCMDCLASSID_CSTTCHMAPS:
            break;

       #endif
           case CFGCLASSID_CIECCFGDATASMNGR:
           break;

#ifdef STT_CMD_PARAS_HAS_GUIDEBOOK
       case STTGBXMLCLASSID_CSTTGUIDEBOOK:
             m_pGuideBook = (CSttGuideBook*)p;

           case STTGBXMLCLASSID_CSTTCONTENTS:
            break;

           case STTGBXMLCLASSID_CSTTITEMS:
                m_pItems = (CSttItems*)p;
           break;

           case DTMCLASSID_CDATATYPES:
                break;
 #endif
            default:
             break;
...
void CSttParas::AttatchItems(CSttItems *pItems)
{
 ...
 曾经考虑使用XFileMngr，但是底层服务使用起来太麻烦，就直接添加此函数
