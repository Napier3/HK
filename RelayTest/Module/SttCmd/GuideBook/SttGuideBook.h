...
public:
	...
	CSttItemBase* InsertItems_InternationalMode(const CString &strParentPath, CSttItems *pItems, BOOL &bUpdateParent);
	CSttItemBase* UpdateBeforeTestItems_InternationalMode(CSttGuideBook *pSttGuideBook);
