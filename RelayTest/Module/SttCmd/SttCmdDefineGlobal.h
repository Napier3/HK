...
//#define STTCMDCLASSID_EXLISTCLASS       (CLASSID_EXLISTCLASS + 0X00010000)
  (CLASSID_BASECLASS + 0X00010000) >> (CLASSID_BASECLASS + 0X00310000)
...
//2024-6-24
#define STTGBXMLCLASSID_CSTTMACROPARADATAS		(STTCMDCLASSID_BASECLASS + 0X00000032)  
#define STTGBXMLCLASSID_CSTTMACROPARADATA		(STTCMDCLASSID_BASECLASS + 0X00000033)  
...
private:
	...
	void Init_DiffPhCorrectMode();//差动校正选择 add wangtao 20241015
