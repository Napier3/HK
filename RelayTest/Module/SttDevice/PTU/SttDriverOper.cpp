...
void CSttDriverOper::keepStop()
{
	//   qDebug()<<"Driver stop";
#ifdef CURLINUX
	drv_reg_ioctl(__FILE__, __LINE__, g_fd, 0x113, 0);
	drv_reg_ioctl(__FILE__, __LINE__, g_fd, 0x103, 0);
#endif
}
...
{
#ifdef CURLINUX
	drv_reg_ioctl(__FILE__, __LINE__, g_fd,ncmd,nValue);
#endif
}
...
{
#ifdef CURLINUX
	int nLen = drv_reg_read(__FILE__, __LINE__, g_fd,buff,0x01);
	//   qDebug()<<"*******************************************nLen is:"<<nLen;
	return nLen;
#endif
}
...
{
#ifdef CURLINUX
	int nLen = drv_reg_ioctl(__FILE__, __LINE__, g_fd,0x208,0);
	return nLen;
#endif
...
#ifdef CURLINUX
	//qDebug("tap %x",nTap);
	drv_reg_ioctl(__FILE__, __LINE__, g_fd,0x105,nTap);
#endif
}
void CSttDriverOper::setMeasTap(int nTap)
{
#ifdef CURLINUX
	drv_reg_ioctl(__FILE__, __LINE__, g_fd,0x104,nTap);
#endif
}
void CSttDriverOper::setInputShake(int nDelay)
{
#ifdef CURLINUX
	drv_reg_ioctl(__FILE__, __LINE__, g_fd,0x111,nDelay);
#endif
}
void CSttDriverOper::setDelayOverload(int nDelay)
{
#ifdef CURLINUX
	drv_reg_ioctl(__FILE__, __LINE__, g_fd,0x112,nDelay);
#endif
}
void CSttDriverOper::setOutPutStatue(int nValue)
{
#ifdef CURLINUX
	drv_reg_ioctl(__FILE__, __LINE__, g_fd,0x107,nValue);
#endif
...
{
#ifdef CURLINUX
	drv_reg_ioctl(__FILE__, __LINE__, g_fd,0x307,0);
	drv_reg_wite(__FILE__, __LINE__, g_fd,pBuff,nLen);
#endif
...
{
#ifdef CURLINUX
	drv_reg_ioctl(__FILE__, __LINE__, g_fd,0x206,nMode);
	lseek(g_fd, nAddr, nMode);
	int nret = drv_reg_read(__FILE__, __LINE__, g_fd,pbuff,nLen);
	return nret;
#endif
}
...
{
#ifdef CURLINUX
	drv_reg_ioctl(__FILE__, __LINE__, g_fd,0x309,1);
	drv_reg_wite(__FILE__, __LINE__, g_fd,pbuff,nLen);
#endif
}
...
int CSttDriverOper::setKeepSendData(char* pBuff,int nLen)
{
	...
	drv_reg_wite(__FILE__, __LINE__, g_fd,pBuff,nLen);
	drv_reg_ioctl(__FILE__, __LINE__, g_fd,0x113,1);
#endif
...
int CSttDriverOper::readRelayIrp()
{
	int nRet;
#ifdef CURLINUX
	nRet = drv_reg_ioctl(__FILE__, __LINE__, g_fd, 0x501, 0);
#endif
	return nRet;
}
...
{
#ifdef CURLINUX
	drv_reg_ioctl(__FILE__, __LINE__, g_fd, 0x30A, 0);
	drv_reg_wite(__FILE__, __LINE__, g_fd, pbuff, nLen);
#endif
}
...
void CSttDriverOper::Init()
{
	setInputShake(20000);
#ifdef CURLINUX
	drv_reg_ioctl(__FILE__, __LINE__, g_fd, 0x110,5);
#endif
}
...
int CSttDriverOper::updateFpga(char* pbuff,int nLen,int nModule)
{
	...
	int nRet = drv_reg_wite(__FILE__, __LINE__, g_fd,pbuff,nLen);
	return nRet;
...
{
#ifdef CURLINUX
	drv_reg_ioctl(__FILE__, __LINE__, g_fd,0x30F,0);
#endif
}
int CSttDriverOper::ReadupdateFpga(char* pbuff,int nType)
{
#ifdef CURLINUX
	int nLen = drv_reg_read(__FILE__, __LINE__, g_fd,pbuff,nType);
...
{
#ifdef CURLINUX
	int nRet = drv_reg_ioctl(__FILE__, __LINE__, g_fd,0x502,0);
	return nRet;
#endif
}
...
{
#ifdef CURLINUX
	int nRet = drv_reg_ioctl(__FILE__, __LINE__, g_fd,0x114,nTap);
	return nRet;
#endif
}
