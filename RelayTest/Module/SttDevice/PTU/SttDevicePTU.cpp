...
int CSttDevicePTU::InitDevice(BOOL bHasAdjFile)
{
	...
	for(int nIndex=0;nIndex<g_theDeviceSystemParameter->m_nModuleCount_U;nIndex++)
	{
		...
		{
			g_theDeviceSystemParameter->m_oModules_U[nIndex]->m_oModuleAttr.m_pPowerCtrlBase=(CSttPowerCtrlBase *)(new CSttPowerCtrlV270_PTU(FALSE));
		}
	}
	...
	for(int nIndex=0;nIndex<g_theDeviceSystemParameter->m_nModuleCount_I;nIndex++)
	{
		...
		if(pCSttPowerCtrlBase==NULL)
		{
			g_theDeviceSystemParameter->m_oModules_I[nIndex]->m_oModuleAttr.m_pPowerCtrlBase=(CSttPowerCtrlBase *)(new CSttPowerCtrlC20());
		}
	}
