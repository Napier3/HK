...
int CSttDevicePID01::InitDevice(BOOL bHasAdjFile)
{
	...
	drv_reg_wite(__FILE__, __LINE__, m_nCommfd,&nData,0x10C);
	return m_nCommfd;
}
...
void CSttDevicePID01::tmt_to_drv_pid01(void *pVoidTmt)
{
	...
	drv_reg_wite(__FILE__, __LINE__, m_nCommfd,&nCtrlData_DIO_0x100,DIO_0x100);
	drv_reg_wite(__FILE__, __LINE__, m_nCommfd,&nCtrlData_DIO_0x101,DIO_0x101);
	drv_reg_wite(__FILE__, __LINE__, m_nCommfd,&nCtrlData_DIO_0x102,DIO_0x102);
	drv_reg_wite(__FILE__, __LINE__, m_nCommfd,&nCtrlData_DIO_0x103,DIO_0x103);
	drv_reg_wite(__FILE__, __LINE__, m_nCommfd,&nCtrlData_DIO_0x104,DIO_0x104);
	drv_reg_wite(__FILE__, __LINE__, m_nCommfd,&nCtrlData_DIO_0x105,DIO_0x105);
	drv_reg_wite(__FILE__, __LINE__, m_nCommfd,&nCtrlData_DIO_0x106,DIO_0x106);
	drv_reg_wite(__FILE__, __LINE__, m_nCommfd,&nCtrlData_DIO_0x107,DIO_0x107);

	drv_reg_wite(__FILE__, __LINE__, nDmafd,&pszDMA,1024);
	...
	drv_reg_wite(__FILE__, __LINE__, m_nCommfd,&nCtrlData_KC,KC_0x10B);
