...
void CSttDevicePNS330_6::SetDrvMoudlePara()
{
	...
	drv_reg_wite(__FILE__, __LINE__, m_nfd, (char *)&oDrv_ModulePara, sizeof(Drv_ModulePara));
	g_oDrvMutex.unlock(__FILE__,__FUNCTION__,__LINE__);
	Sleep(10);

	g_oDrvMutex.lock(__FILE__,__FUNCTION__,__LINE__);
	drv_reg_ioctl(__FILE__, __LINE__, m_nfd, 0x356, 0);
	drv_reg_wite(__FILE__, __LINE__, m_nfd, (char *)&m_oModuleMaxVaildCnt, sizeof(Drv_ModuleMaxVaildCnt));
	g_oDrvMutex.unlock(__FILE__,__FUNCTION__,__LINE__);
}
