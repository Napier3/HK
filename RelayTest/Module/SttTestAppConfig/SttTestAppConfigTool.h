...
public:
	...
	CSttTestEngineClientData* CreateTestEngine(CSttTestAppCfg *pSttTestAppCfg, CString &strErrorInfo);
...
protected:
	CSttTestEngineClientData* CreateTestCtrlEngine(CSttTestAppCfg *pSttTestAppCfg, const CString &strSoftID, CString &strErrorInfo);
	CSttTestEngineClientData* CreateAtsEngine(CSttTestAppCfg *pSttTestAppCfg, const CString &strSoftID, CString &strErrorInfo);
...
public:
	...
	CString m_strSoftID;
	CString m_strServerID;    连接的服务端ID
...
public:
	...
	static BOOL IsTestAppExist(CSttTestAppCfg *pSttTestAppCfg, CString &strErrorInfo);
