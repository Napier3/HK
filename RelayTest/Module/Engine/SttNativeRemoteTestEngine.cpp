#include "stdafx.h"
#include "SttNativeRemoteTestEngine.h"
...
CSttNativeRemoteTestEngine* CSttNativeRemoteTestEngine::g_pNativeTestEngine = NULL;
long CSttNativeRemoteTestEngine::g_nNativeTestEngineRef = 0;
CSttNativeRemoteTestEngine *g_theNativeTestEngine = NULL;

CSttNativeRemoteTestEngine* CSttNativeRemoteTestEngine::Create(const char *pszIP, int nPort)
{
	...
	if (g_nNativeTestEngineRef == 1)
	{
		...
		g_pNativeTestEngine = new CSttNativeRemoteTestEngine();
...
void CSttNativeRemoteTestEngine::Release()
{
	g_nNativeTestEngineRef--;
...
CSttNativeRemoteTestEngine* CSttNativeRemoteTestEngine::GetNativeTestEngine()
{
	return g_pNativeTestEngine;
}

CSttNativeRemoteTestEngine::CSttNativeRemoteTestEngine()
{
    m_pSmartTest = NULL;
...
void CSttNativeRemoteTestEngine::InitClientUserMngr()
{
...
void CSttNativeRemoteTestEngine::AttachRefAtsUser(CSttTestClientUser *pRefAtsUser)
{
    m_pRefAtsUser = pRefAtsUser;
    m_oClientUserMngr.AddTail(m_pRefAtsUser);
}

void CSttNativeRemoteTestEngine::InitSttServerEngine(const char *pszIP, int nPort)
{
...
void CSttNativeRemoteTestEngine::ExitSttServerEngine()
{
...
void CSttNativeRemoteTestEngine::OnSocketClose(CSttSocketDataBase *pSocket)
{
...
BOOL CSttNativeRemoteTestEngine::SendBufferToChildren(CSttSocketDataBase *pExceptSocket,BYTE *pBuf,long nLen)
{
    if(m_pSttCloudClientSocket != NULL)
    {
...
long CSttNativeRemoteTestEngine::SendSysState(CSttSysState *pSysState)
{
    return m_pSttCloudClientSocket->SendSysState(pSysState);
}

//收到测试命令，先检查是否有权限，无权限则返回失败
BOOL CSttNativeRemoteTestEngine::CheckBeforeProcessCmdTest(CSttSocketDataBase *pClientSocket, BYTE *pBuf, long nLen, char *pszCmdID, char *pszTestor)
{
...
BOOL CSttNativeRemoteTestEngine::CheckBeforeProcessCmdAts(CSttSocketDataBase *pClientSocket, BYTE *pBuf, long nLen, char *pszCmdID, char *pszTestor)
{
    CSttSystemCmd oSysCmd;
...
//本地Ats和远程登录
long CSttNativeRemoteTestEngine::Process_Cmd_System_Login(CSttSocketDataBase *pClientSocket, CSttSystemCmd &oSysCmd)
{
...
long CSttNativeRemoteTestEngine::Process_Cmd_System_Logout(CSttSocketDataBase *pClientSocket, CSttSystemCmd &oSysCmd)
{
	//更新用户链表
	DWORD nIDTester = 0;
...
void CSttNativeRemoteTestEngine::CheckStopTestAfterReleaseUser()
{//退出登录或断链，检查是否停止测试
...
//只检测具有单机测试权限的测试端心跳超时
void CSttNativeRemoteTestEngine::CheckHeartbeatOverTime()
{
...
BOOL CSttNativeRemoteTestEngine::OnTestMsgEx(CSttSocketDataBase *pClientSocket, BYTE *pBuf, long nLen, long nCmdType, char *pszCmdID, char *pszTestor, char *pszRetCmdType, BOOL &bRet)
{
      监视所有命令报文
...
long CSttNativeRemoteTestEngine::Process_SysState(CSttSocketDataBase *pClientSocket, CSttSysState &oSysState)
{
...
long CSttNativeRemoteTestEngine::Process_SysState_Register(CSttSysState &oSysState)
{//收到云端注册应答
...
long CSttNativeRemoteTestEngine::Process_SysState_UnRegister(CSttSysState &oSysState)
{//收到取消云端注册应答
	long nCmdExecState = oSysState.Get_ExecStatus();
...
long CSttNativeRemoteTestEngine::Process_SysState_InputData(CSttSocketDataBase *pClientSocket,CSttSysState &oSysState)
{
	long nCmdExecState = oSysState.Get_ExecStatus();
...
long CSttNativeRemoteTestEngine::ConnectCloudServer(const CString &strIPServer,long nPort)
{
    if (m_pSttCloudClientSocket == NULL)
    {
    ...
    return m_pSttCloudClientSocket->ConnectServer(strIPServer,nPort);
}

void CSttNativeRemoteTestEngine::DisConnectCloudServer()
{
    if (m_pSttCloudClientSocket != NULL)
    {
...
long CSttNativeRemoteTestEngine::SendCmd(CSttCmdBase *pCmd,long nTimeOut,BOOL bCompress,BOOL bReset)
{
    if (m_pSttCloudClientSocket == NULL)
    {
...
long CSttNativeRemoteTestEngine::SendCmdSync(CSttCmdBase *pCmd,long nTimeOut,CSttCmdData *pRetData,BOOL bDoEvents)
{
	if (m_pSttCloudClientSocket == NULL)
	{
		CLogPrint::LogString(XLOGLEVEL_INFOR,_T("m_pSttCloudClientSocket == NULL"));
...
// long CSttNativeRemoteTestEngine::ReturnSysState(long nCmdExecStatus)
// {
// 	//xxy测试命令应答
...
long CSttNativeRemoteTestEngine::Register(CSttCmdData *pRetData)
{
...
long CSttNativeRemoteTestEngine::UnRegister(CSttCmdData *pRetData)
{
    CSttRemoteCmd oRemoteCmd;
...
long CSttNativeRemoteTestEngine::Ats_InputData(CSttSocketDataBase *pClientSocket,CDataGroup *pDatas,CExBaseList *pMsgs)
{
...
BOOL CSttNativeRemoteTestEngine::AuthorityToAtsUser(CSttSystemCmd &oSysCmd,CSttTestClientUser *pUser)
{
	long nAuthority = 0;
...
BOOL CSttNativeRemoteTestEngine::AuthorityToTestUser(CSttSystemCmd &oSysCmd,CSttTestClientUser *pUser)
{//远程单机测试权限
	long nAuthority = 0;
	long nExecStatus = 0;
...
long CSttNativeRemoteTestEngine::AuthorityToUser(CSttSystemCmd &oSysCmd,BOOL bRequest,BOOL bBroadcastWhenSuccess)
...
BOOL CSttNativeRemoteTestEngine::IsCanAuthorityToRefAtsUser(long nAtsAuthority,BOOL bRequest)
{
...
long CSttNativeRemoteTestEngine::AuthorityToRefAtsUser(long nAtsAuthority,BOOL bRequest)
{
    if (m_pRefAtsUser == NULL)
    {
        return 0;
...
long CSttNativeRemoteTestEngine::CheckCancelNativeClientAuthority()
...
*/
long CSttNativeRemoteTestEngine::CheckUpdateTestControlAuthority()
{
	CSttTestClientUser *pFind = m_oClientUserMngr.FindHasAuthority(KEY_AUTHORITY_MODULE_Ats);
...
CSttTestClientUser* CSttNativeRemoteTestEngine::User_Login(CSttSocketDataBase *pClientSocket, CSttSystemCmd &oSysCmd)
{
...
long CSttNativeRemoteTestEngine::Process_Cmd_System_Request(CSttSocketDataBase *pClientSocket, CSttSystemCmd &oSysCmd)
{
	//0:不可授权，1：已授权，2、可授权但未授权
...
long CSttNativeRemoteTestEngine::Process_Cmd_System_Authority(CSttSocketDataBase *pClientSocket, CSttSystemCmd &oSysCmd)
{
	//0:不可授权，1：已授权，2、可授权但未授权
...
long CSttNativeRemoteTestEngine::ReturnExecReply(long nCmdExecStatus,CSttCmdData *pRetData)
{
	//xxy测试命令应答
	if (m_oSttAtsCmd.GetRefSocketData() == NULL)
	{
...
long CSttNativeRemoteTestEngine::Process_Cmd_Ats(CSttSocketDataBase *pClientSocket
...
long CSttNativeRemoteTestEngine::Process_Cmd_Ats(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
// #ifdef _SttTestServer_For_Debug_
...
*/
CDvmDataset* CSttNativeRemoteTestEngine::Ats_GetDataset(CSttAtsCmd &oAtsCmd)
{
...
*/
long CSttNativeRemoteTestEngine::Ats_SetDataset(CSttAtsCmd &oAtsCmd)
{
...
*/
long CSttNativeRemoteTestEngine::Ats_ConfigDevice(CSttAtsCmd &oAtsCmd)
{
#ifdef _PSX_QT_LINUX_
...
void CSttNativeRemoteTestEngine::Return_Ats_Success(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd, unsigned int nState, CDvmDataset *pDatas, CExBaseObject *pGuideBook)
{
    CSttSysState oSysState;
...
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_CreateTest(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
...
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_StartTest(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
    CSttSysState oSysState;
    oSysState.UpdateSysStateHead(&oAtsCmd);
...
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_StopTest(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
    CSttSysState oSysState;
    oSysState.UpdateSysStateHead(&oAtsCmd);
...
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_CloseTest(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
    CSttSysState oSysState;
    oSysState.UpdateSysStateHead(&oAtsCmd);
...
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_TestItem(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
    CSttSysState oSysState;
    oSysState.UpdateSysStateHead(&oAtsCmd);
...
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_TestFrom(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
    CSttSysState oSysState;
    oSysState.UpdateSysStateHead(&oAtsCmd);
...
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_TestAllFailedItems(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
    CSttSysState oSysState;
    oSysState.UpdateSysStateHead(&oAtsCmd);
...
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_GetItemReport(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
    CSttSysState oSysState;
    oSysState.UpdateSysStateHead(&oAtsCmd);
...
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_GetReportFile(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
    CSttSysState oSysState;
    oSysState.UpdateSysStateHead(&oAtsCmd);
...
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_GetSystemState(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
    CSttSysState oSysState;
    oSysState.UpdateSysStateHead(&oAtsCmd);
...
<sys-state>
*/
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_CreateDevice(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
	ReturnExecReply(STT_CMD_ExecStatus_ACK);
...
/*
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_ConnectDevice(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
	ReturnExecReply(STT_CMD_ExecStatus_ACK);
...
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_ConfigDevice(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
	ReturnExecReply(STT_CMD_ExecStatus_ACK);
    CSttSysState oSysState;
    oSysState.UpdateSysStateHead(&oAtsCmd);
...
<sys-state>
*/
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_GetDataset(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
	ReturnExecReply(STT_CMD_ExecStatus_ACK);
...
<sys-state>
*/
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_SetDataset(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
	ReturnExecReply(STT_CMD_ExecStatus_ACK);
    CSttSysState oSysState;
    oSysState.UpdateSysStateHead(&oAtsCmd);
...
*/
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_RunProcedure(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
	ReturnExecReply(STT_CMD_ExecStatus_ACK);
...
*/
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_CloseDevice(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
	ReturnExecReply(STT_CMD_ExecStatus_ACK);
...
*/
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_ConfigEngine(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
	ReturnExecReply(STT_CMD_ExecStatus_ACK);
...
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_FinishInputData(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
    CSttSysState oSysState;
    oSysState.UpdateSysStateHead(&oAtsCmd);
...
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_QueryAtsFile(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
    CSttSysState oSysState;
    oSysState.UpdateSysStateHead(&oAtsCmd);
...
long CSttNativeRemoteTestEngine::Process_Cmd_Ats_SetItemState(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
{
    CSttSysState oSysState;
    oSysState.UpdateSysStateHead(&oAtsCmd);
...
void CSttNativeRemoteTestEngine::Return_NoDevice(CSttSocketDataBase *pClientSocket, CSttSysState &oSysState)
{
    oSysState.Set_ExecStatus_Failure();
...
void CSttNativeRemoteTestEngine::Return_Ats_Event(CSttSocketDataBase *pClientSocket, CSttSysState &oSysState)
{
    if (pClientSocket != NULL)
    {
...
long CSttNativeRemoteTestEngine::ValidateSmartTest(CSttSocketDataBase *pClientSocket, CSttSysState &oSysState)
{
    if (m_pSmartTest != NULL)
    {
        return 1;
...
void CSttNativeRemoteTestEngine::OnTimer()
{
