...
protected:
    ...
    long Process_Cmd_Ats_ClearReportsRslts(void *pClientSocket, CSttAtsCmd &oAtsCmd);
	long Process_Cmd_Ats_UpdateReportHead(void *pClientSocket, CSttAtsCmd &oAtsCmd);
	long Process_Cmd_Ats_UpdateCharacteristic(void *pClientSocket, CSttAtsCmd &oAtsCmd);
...
protected:
        virtual long ReturnSysState(void *pComm, CSttSysState *pSysState, long nSpyAllCmd);
        virtual long ReturnSysStateToChildren(void *pComm,CSttSysState *pSysState);
        virtual long X_SendSysState(void *pComm, CSttSysState *pSysState, long nSpyAllCmd);
        virtual long RetFailureSysState(CSttCmdBase *pCmd);
        virtual long X_SendCmd(void *pComm, CSttCmdBase *pSttCmdBase, long nSpyAllCmd);
