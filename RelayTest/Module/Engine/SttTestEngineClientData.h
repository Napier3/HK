...
extern long g_nTimeOut_Meas; 

extern long g_nAtsGenTemplateForDebug;  

#define SttXcmdChType_SttClientSocket   0
#define SttXcmdChType_AxAtsLib              1
extern long g_nSttXcmdCh_Type;
...
*/
	CSttXcmdChInterface *m_pSttClientSocket;
...
public:
	...
	long Ats_StartTest(CDataGroup *pTestMacroUI=NULL, CDataGroup *pUIParas=NULL, CDataGroup *pCommCmd=NULL, CSttContents *pCharacteristic=NULL, 
		BOOL bDoEvents=TRUE,CSttCmdData *pRetData = NULL,const CString &strDvmFile = _T(""), long nTestMode = TEST_MODE_SINGLETEST);//20230227 zhouhj 增加strDvmFile
	...
	long Process_Cmd_Ats_InputData(CSttXcmdChInterface *pClientSocket, CSttAtsCmd &oAtsCmd);
    ...
    long Ats_GenerateTemplate(CDataGroup *pGenParas,const CString &strRetMode, long nHasDigital,bool bDoEvents=TRUE,CSttCmdData *pRetData = NULL,const CString &strDvmFile = _T(""));//多功能的模板生成
	...
	long Ats_CreateTemplate(const CString &strTestMacroUI_ID, const CString &strDeviceName, const CString &strDeviceID, const CString &strDvmFile,
		long nHasDigital,bool bDoEvents=TRUE,CSttCmdData *pRetData = NULL);
	long Ats_UpdateReportHead(CDataGroup *pReportHead,bool bDoEvents = TRUE, CSttCmdData *pRetData = NULL);
	long Ats_UpdateCharacteristic(CSttContents *pChar, const CString &strParentItemsPath, bool bDoEvents = TRUE, CSttCmdData *pRetData = NULL);
	...
	long Debug_ConfigDebug(const CString &strDebugParaID, long nValue);  add spy-cmd
...
public:
	...
	virtual long Process_SysState_System_ReadMeas(CSttSysState &oSysState); 
	virtual long Process_SysState_System_LiveUpdate(CSttSysState &oSysState);
    virtual long Process_SysState_System_License(CSttSysState &oSysState);
