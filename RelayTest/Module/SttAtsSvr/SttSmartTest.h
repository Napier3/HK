...
public:
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////
	long Post_Ats_CreateTest(CSttAtsCmd *pAtsCmd);   发送自动测试创建消息给主线程，创建测试，自动测试主线程调用 On_Ats_CreateTest
	long On_Ats_CreateTest(CSttAtsCmd *pAtsCmd);    执行自动测试创建，被主线程消息函数调用
 	long Post_Ats_ExportReport(CSttAtsCmd *pAtsCmd);   发送自动测试创建消息给主线程，创建测试，自动测试主线程调用 On_Ats_CreateTest
	virtual long Pre_Ats_ExportReport(CSttAtsCmd *pAtsCmd);    执行自动测试创建，被主线程消息函数调用
