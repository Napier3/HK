...
#define STT_CNTR_CMD_CharacterEdit		"CharacterEdit"//特性曲线编辑  2024.7.17
#define STT_CNTR_CMD_NewTest				"NewTest"
#define STT_CNTR_CMD_TestedObject		"TestedObject"
...
#define STT_CNTR_CMD_ZTView				"ZTView"//20240729 luozibing ZT视图
#define STT_CNTR_CMD_SystemView			 "SystemView" // 2024-8-8 wuxinyi 系统图
#define STT_CNTR_CMD_WiringView			 "WiringView" // 2024-8-8 wuxinyi 接线图
...
#define STT_CNTR_CMD_IecBinRecord			"IecBinRecord"//20240812 zhouyangyong新增开关量录波
#define STT_CNTR_CMD_BinConfig				"BinConfig"//20240903 zhouyangyong 新增主板开关量配置
...
//国际版-距离保护
#define  STT_ORG_MACRO_DistanceTest_I            "DistanceTest_I"
//2024.6.26 zhangyq 国际版-电流反时限
#define  STT_ORG_MACRO_CurrInverseTimeTest_I     "CurrInverseTimeTest_I"
// 国际版-电压反时限
#define  STT_ORG_MACRO_VolInverseTimeTest_I     "VolInverseTimeTest_I"

#define  STT_ORG_MACRO_ActionTimeTest_I            "ActionTimeTest_I"//国际版-动作时间
#define  STT_ORG_MACRO_DistanceSearchTest_I            "DistanceSearchTest_I"//国际版-阻抗搜索
#define  STT_ORG_MACRO_RecloseAccTest_I            "RecloseAccTest_I"//国际版-重合闸及后加速
#define  STT_ORG_MACRO_PowerDirectionTest_I            "PowerDirectionTest_I"//国际版-功率方向

//zhouhj 2024.10.8删除重复添加
//#define  STT_ORG_MACRO_ActionTimeTest_I            "ActionTimeTest_I"//国际版-动作时间

#define	 STT_ORG_MACRO_LowFreqTest_I               "LowFreqTest_I"  //国际版-低周减载
#define	 STT_ORG_MACRO_LowVolTest_I               "LowVolTest_I"  //国际版-低周减载
#define	 STT_ORG_MACRO_DiffTest_I                  "DiffTest_I"   //国际版-差动

#define  STT_ORG_MACRO_DiffCBOpTest_I           "DiffCBOpTest_I"//国际版-整组差动   xueyangfan
#define  STT_ORG_MACRO_SynTest_I                 "SynTest_I"//2024.7.4 zhangyq 国际版-自动准同期
...
#define  STT_ORG_MACRO_SwingTest             "SwingTest"
...
#define  STT_ORG_MACRO_ImpedManualTest               "ImpedManualTest" //2024.6.11 zhangyq通用试验（阻抗）
