...
void QSttBatteryButton::UpdateState(CDataGroup *pDataGroup)  
{
...
void QSttGpsButton::UpdateState(CDataGroup *pDataGroup)  
{
...
void QSttBlueToothButton::UpdateState(CDataGroup *pDataGroup)  
{
	long nBle = -1;
