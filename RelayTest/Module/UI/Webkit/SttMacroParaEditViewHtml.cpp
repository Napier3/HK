...
: QSttWebViewBase(parent)
{
	...
	m_pHtmlSttTestResource = stt_GetSttTestResource();
//	CreateTestResource();
...
// 	}
// 
// 	if (stt_Frame_TestMacroUI()->m_strHdRsFile == STT_TEST_RESOURCE_FILENAME_6U6I)
// 	{
// 		g_theTestCntrFrame->m_pSttTestResource = new CSttTestResource_6U6I();
// 	}
// 	else if (stt_Frame_TestMacroUI()->m_strHdRsFile == STT_TEST_RESOURCE_FILENAME_4U3I)
// 	{
// 		g_theTestCntrFrame->m_pSttTestResource = new CSttTestResource_4U3I();
// 	}
// 	else
...
{
	//m_pRetParasRef->DeleteAll();   不删除，只进行赋值
...
//		CLogPrint::LogFormatString(XLOGLEVEL_INFOR,("UI_OK_Click pszParas1=%s"),pszParas1);
		...
		if (nLen2>0)//zhouhj 如果当前传入的通道映射内容不为空,则更新通道映射
		{
			...
			//g_oSttTestResourceMngr.m_oChMaps.UpdateWeekRateValue();	//20240919 huangliang 
			Global_UpdateWeekRateValue(&g_oSttTestResourceMngr.m_oChMaps);
		}
