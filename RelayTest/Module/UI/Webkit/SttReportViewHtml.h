...
signals:
	...
	void msg_FillReportDataset(QVariant strParentItemsPath, QVariant strItemID, QVariant strDataset); 
	void msg_FillRptMapDatas(QVariant pszRptMapDatas, QVariant strState); 
	void msg_QueryReportFillMode(); 
