...
public:
	...
	explicit QImpCharactWidget(CCharacteristics *pCharacteristics,QWidget *parent = 0, bool bUseOptrButtons = FALSE, BOOL bUseMouseMoveChar = FALSE);
    ~QImpCharactWidget();
...
// 	void updataPlotColor(TestInfo info);
	...
	void SetShowCurrCharactColor(BOOL bShowCurrCharactColor);
    void SetCurCharact(CCharacteristic *pCharacterist);
