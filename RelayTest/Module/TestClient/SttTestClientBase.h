...
class CSttTestClientBase : public CExBaseList
	...
	, public CXTimer  使用窗口作为定时器，以及后续的消息扩展
{
public:
	CSttTestClientBase();
...
//////////////////////////////////////////////////////////////////////////
  提取的，基于STT协议部分的公共接口函数，便于STT和MQTT两种方式进行兼容
public:
	//CSttTestEngineClientData* GetTestEngineClient()	{	return m_pXClientEngine;	}
	...
	BOOL ConnectSttServer(CSttTestAppConfigTool *pTool, CString &strErrorInfo);
...
public:
	...
	long Debug_ConfigDebug(long nLogDataBind,long nLogPkgDataInfor,long nLogPkg
		,long nLogDebugInfor,long nNoChangeWhenSame, long nSpyCmd);   add spy-cmd
